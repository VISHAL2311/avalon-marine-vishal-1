                ...
                <div class="col-md-12 col-xs-12" data-aos="fade-up">
                    ...
                    <div class="cms serv-detail-content">
                        ...
                        @foreach($imgArr as $img)
                            <img alt="{!!$work->varTitle!!}" src="{{ App\Helpers\resize_image::resize($img,870,488)}}" data-image="{{ App\Helpers\resize_image::resize($img,870,489)}}" data-description="{!!$work->varTitle!!}">
                        @endforeach
                        @endif
                        </div>
...
<script src="{{ $CDN_PATH . 'assets/libraries/unite/js/unitegallery.min.js' }}"></script>
<script src="{{ $CDN_PATH . 'assets/libraries/unite/js/ug-theme-default.js' }}"></script>
<script>
