...
//				},
		    ...
		    if (tableState) {
		    	  if($.cookie('Worksearch')) {
					      var Worksearch = $.cookie('Worksearch');
	                $('#searchfilter').val(Worksearch);
	                grid.setAjaxParam("searchValue", Worksearch);
	           ...
	           if($.cookie('statusValue') && $.cookie('statusValue') != 'null' && $.cookie('statusValue') != ''){
				...
				grid.init({
						...
						dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options 
								...
								"ajax": {
										"url": window.site_url + "/powerpanel/work/get_list", // ajax source
								},
...
// 	if($.cookie('Worksearch')){
// 		$('#searchfilter').val($.cookie('Worksearch'));
// 		$('#searchfilter').trigger('keyup');	
// 	}
// });
...
function reorder(curOrder, excOrder) {
		var ajaxurl = site_url + '/powerpanel/work/reorder';
		$.ajax({
				url: ajaxurl,
				data: {
						order: curOrder,
...
function makeFeatured(fid, status) {
		var ajaxurl = site_url + '/powerpanel/work/makeFeatured';
		$.ajax({
				url: ajaxurl,
