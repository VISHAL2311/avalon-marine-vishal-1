...
<div class="row">
  <div class="col-md-12">
    ...
    <div class="title-dropdown_sec">
      ...
      @include('powerpanel.partials.listbreadcrumbs',['ModuleName'=>'Manage Boat'])
      @endif
              ...
              <div class="col-lg-6 col-md-12 col-xs-12">
                <div class="portlet-lf-title">
                  <div class="sub_select_filter" id="hidefilter">
                    <span class="title">{!! trans('boat::template.common.filterby') !!}:</span>
                    <span class="select_input">
                      <select id="statusfilter" data-sort data-order class="bs-select select2">
                        <option value=" ">{!! trans('boat::template.common.selectstatus') !!}</option>
                        <option value="Y">{!! trans('boat::template.common.publish') !!}</option>
                        <option value="N">{!! trans('boat::template.common.unpublish') !!}</option>
                      </select>
                    </span>
              ...
              <div class="col-lg-6 col-md-12 col-xs-12">
                <div class="portlet-rh-title">
                  ...
                  <div class="add_category_button pull-right">
                    <a class="add_category" href="{{ url('powerpanel/boat/add') }}" title="{{ trans('boat::template.boatModule.addBoat') }}"><span>{{ trans('boat::template.boatModule.addBoat') }}</span> <i class="la la-plus"></i></a>
                  </div>
                  @endcan
                </div>
              </div>
    ...
    <div class="portlet light portlet-fit portlet-datatable bordered">
      @if($iTotalRecords > 0)
      <div class="portlet-title select_box boat_select_box">
        <div class="col-md-12 col-sm-12 ">
          <div class="row">
            <div class="row col-md-6 col-sm-12 pull-right search_pages_div">
              <div class="search_rh_div">
                <span>{{ trans('boat::template.common.search') }}:</span>
        ...
        <div class="portlet-body">
          <div class="table-container">
            <table class="new_table_desing table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
              <thead>
                <tr role="row" class="heading">
                  ...
                  <th width="22%" align="left">{{ trans('boat::template.common.title') }}</th>
                  <th width="11%" align="center">{{ trans('boat::template.common.shortdescription') }} </th>
                  <th width="5%" align="center">{{ trans('boat::template.common.image') }}</th>
                  <th width="5%" align="center">HITS</th>
                  <th width="10%" align="center">{{ trans('boat::template.common.order') }}</th>
                  <th width="5%" align="center">{{ trans('boat::template.common.publish') }}</th>
                  <th width="5%" align="right">{{ trans('boat::template.common.actions') }}</th>
                </tr>
              </thead>
              <tbody> </tbody>
            </table>
            ...
            <a href="javascript:;" class="btn-sm btn btn-outline red right_bottom_btn deleteMass">
              {{ trans('boat::template.common.delete') }}
            </a>
            @endcan
          </div>
        </div>
  ...
  <script type="text/javascript">
    window.site_url = '{!! url("/") !!}';
    var DELETE_URL = '{!! url("/powerpanel/boat/DeleteRecord") !!}';
  ...
  <script src="{{ url('resources/pages/scripts/packages/boat/boat-datatables-ajax.js') }}" type="text/javascript"></script>
