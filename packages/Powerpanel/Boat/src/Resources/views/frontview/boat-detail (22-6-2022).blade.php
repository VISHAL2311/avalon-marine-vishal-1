            ...
            <div class="row w-100 boat-content mx-0 px-0">
                <div class="col-lg-8 col-sm-12  p-lg-0 p-sm-3 pr-lg-4">
                    ...
                    <div class="boat_title_price">
                        <div class="location d-flex align-items-center"><img src="{{ url('/') }}/{{ ('assets/images/location.svg') }}" alt="Location"> {!!
                            htmlspecialchars_decode($boat->varBoatLocation) !!}</div>
                            ...
                            <div id="collapseFour" class="collapse" aria-labelledby="headingFour"
                                ...
                                <div class="card-body list-block">
                                    ...
                                    <div class="list-content">
                                        ...
                                        <p>Cruising Speed : <span>{!!
                                                htmlspecialchars_decode($boat->varCruisingSpeed) !!}</span></p>
                                        @endif
                                        @if(isset($boat->varMaxSpeed) && !empty($boat->varMaxSpeed))
                                        <p>Max Speed : <span>{!! htmlspecialchars_decode($boat->varMaxSpeed) !!}</span>
                                        </p>
                                        @endif
                                    </div>
                                    @endif
                                    ...
                                    <div class="list-content">
                                        ...
                                        <p>Length Overall : <span>{!! htmlspecialchars_decode($boat->varLengthOverall)
                                                !!}</span></p>
                                        @endif
                                        @if(isset($boat->varBridgeclearance) && !empty($boat->varBridgeclearance))
                                        <p>Max Bridge Clearance : <span>{!!
                                                htmlspecialchars_decode($boat->varBridgeclearance) !!}</span></p>
                                        @endif
                                        @if(isset($boat->varMaxDraft) && !empty($boat->varMaxDraft))
                                        <p>Max Draft : <span>{!! htmlspecialchars_decode($boat->varMaxDraft) !!}</span>
                                        </p>
                                        @endif
                                        @if(isset($boat->varBeam) && !empty($boat->varBeam))
                                        <p>Beam : <span>{!! htmlspecialchars_decode($boat->varBeam) !!}</span></p>
                                        @endif
                                        @if(isset($boat->varCabinHeadroom) && !empty($boat->varCabinHeadroom))
                                        <p>Cabin Headroom : <span>{!! htmlspecialchars_decode($boat->varCabinHeadroom)
                                                !!}</span></p>
                                        @endif
                                        @if(isset($boat->varLengthAtWaterline) && !empty($boat->varLengthAtWaterline))
                                        <p>Length at Waterline : <span>{!!
                                                htmlspecialchars_decode($boat->varLengthAtWaterline) !!}</span></p>
                                        @endif
                                    </div>
                                    @endif
                                    ...
                                    <div class="list-content">
                                        ...
                                        <p>Dry Weight : <span>{!! htmlspecialchars_decode($boat->varDryWeight)
                                                !!}</span></p>
                                        @endif
                                    </div>
                                    @endif
                                    ...
                                    <div class="list-content">
                                        ...
                                        <p>Windlass : <span>{!! htmlspecialchars_decode($boat->varWindlass) !!}</span>
                                        </p>
                                        @endif

                                        @if(isset($boat->varDeadriseAtTransom) && !empty($boat->varDeadriseAtTransom))
                                        <p>Deadrise at Transom : <span>{!!
                                                htmlspecialchars_decode($boat->varDeadriseAtTransom) !!}</span></p>
                                        @endif

                                        @if(isset($boat->varElectricalCircuit) && !empty($boat->varElectricalCircuit))
                                        <p>Electrical Circuit : <span>{!!
                                                htmlspecialchars_decode($boat->varElectricalCircuit) !!}</span></p>
                                        @endif
                                        @if(isset($boat->varSeatingCapacity) && !empty($boat->varSeatingCapacity))
                                        <p>Seating Capacity : <span>{!!
                                                htmlspecialchars_decode($boat->varSeatingCapacity) !!}</span></p>
                                        @endif
                                    </div>
                                    @endif
                                    ...
                                    <div class="list-content">
                                        ...
                                        <p>Fresh Water Tank : <span>{!!
                                                htmlspecialchars_decode($boat->varFreshWaterTank) !!}</span></p>
                                        @endif

                                        @if(isset($boat->varFuelTank) && !empty($boat->varFuelTank))
                                        <p>Fuel Tank : <span>{!! htmlspecialchars_decode($boat->varFuelTank) !!}</span>
                                        </p>
                                        @endif

                                        @if(isset($boat->varHoldingTank) && !empty($boat->varHoldingTank))
                                        <p>Holding Tank : <span>{!! htmlspecialchars_decode($boat->varHoldingTank)
                                                !!}</span></p>
                                        @endif
                                    </div>
                                    @endif
                                    ...
                                    <div class="list-content">
                                        ...
                                        <p>Single Berths : <span>{!! htmlspecialchars_decode($boat->varSingleBerths)
                                                !!}</span></p>
                                        @endif

                                        @if(isset($boat->varHeads) && !empty($boat->varHeads))
                                        <p>Heads : <span>{!! htmlspecialchars_decode($boat->varHeads) !!}</span></p>
                                        @endif
                                    </div>
                                    @endif
                                </div>
