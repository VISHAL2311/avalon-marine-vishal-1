<div class="modal fade bd-example-modal-lg composer-element-popup ckeditor-popup ckbusiness-popup" id="sectionBoatModule" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="ac-modal-table">
        <div class="ac-modal-center">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['method' => 'post','id'=>'frmSectionBoatModule']) !!}
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel"><b>Add Boat</b></h5>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group" style="display:none;">
                            ...
                            <select name="layoutType" class="form-control bootstrap-select bs-select" id="boat-layout">
                                        ...
                                        <table class="responsive new_table_desing table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr role="row" class="heading">
                                                    ...
                                                    <th width="40%" align="left">{{ trans('boat::template.common.title') }}</th>
                                                    <th width="40%" align="center">Image</th>
                                                </tr>
                                            </thead>
                                        </table>
                                        <div class="table-scrollable full-info-table" id="mcscroll" style="height: 200px">
                                            <table class="responsive new_table_desing table table-striped table-bordered table-hover table-checkable" id="datatable_boat_ajax">
