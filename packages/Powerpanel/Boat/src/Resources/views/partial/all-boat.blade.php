<div class="modal fade bd-example-modal-lg composer-element-popup ckeditor-popup ckbusiness-popup" id="sectionBoatModuleTemplate" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            {!! Form::open(['method' => 'post','id'=>'frmSectionBoatModuleTemplate']) !!}
            ...
            <div class="modal-body">
                ...
                <div class="form-group" style="display:none;">
                    ...
                    <select name="layoutType" class="form-control bootstrap-select bs-select" id="boat-template-layout">
