...
graphicsDir : site_url + '/resources/global/plugins/highslide/graphics/',
...
expand_custom : function(a, params, custom, type,CountYes,CountNo,Id) {
//    alert('a');
openchart(CountYes,CountNo,Id);
...
htmlExpandCustom : function(a, params, custom,CountYes,CountNo,Id) {
    return hs.expand_custom(a, params, custom, 'html',CountYes,CountNo,Id);
},
