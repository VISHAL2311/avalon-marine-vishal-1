    ...
    return {
        ...
        init: function (options) {
            ...
            options = $.extend(true, {
                ...
                dataTable: {
                    "dom": "<'row datatable_head  top-datatable_head'<'col-lg-8 col-sm-12'pli><'col-lg-4 col-sm-12'<'table-group-actions pull-right'>>r><'table-responsive't><'row datatable_head'<'col-lg-8 col-sm-12'pli><'col-lg-4 col-sm-12'>>", // datatable layout
