                    ...
                    if (!empty($section2) && is_array($section2)) {
                        foreach ($section2 as $section1) {
                            ...
                            if ($module == 'only_title') {
                                ...
                                $response .= Self::ContentHTML($title, $content, $alignment, $src, $image,$btnurl);
                                ...
                                $filter = $section1['val']['template'];
                                $layout = $section1['val']['layout'];
                                $response .= Self::testimonialHTML($title, $records, $filter, $layout);
...
//        $recIds = array_column($records, 'id');
    ...
    static function testimonialHTML($title, $records, $filter, $layout) {
        $response = '';
        $response = '';
        $recIds = array_column($records, 'id');
...
//        $recIds = array_column($records, 'id');
    ...
    static function videoalbumHTML($title, $desc, $config, $layout, $records, $filter, $extraclass) {
        $response = '';
        $recIds = array_column($records, 'id');
        $fields = Self::selectFields($config);
    ...
    static function TwoColumnsHTML($content, $type, $subtype, $partitionclass, $two) {
        $response = '';
    ...
    static function DocumentHTML($document, $img) {
        $response = '';
        $data = [
            'document' => $document
        ];
