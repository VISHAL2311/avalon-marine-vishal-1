...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="title-dropdown_sec">
            ...
            @include('powerpanel.partials.listbreadcrumbs',['ModuleName'=>'Feedback Lead'])
            @endif
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-12 col-xs-12">
                                <div class="portlet-rh-title">
                                    ...
                                    <a class="btn btn-green-drake pull-right btn-rh-search" style="margin-right:15px;" id="appointmentDate" href="javascript:;"><i class="fa fa-search"></i></a>
                                    <div class="event_datepicker pull-right">
                                        <div class="new_date_picker input-group input-large date-picker input-daterange" data-date-format="{{Config::get('Constant.DEFAULT_DATE_FORMAT')}}">
                                            <!-- <span class="input-group-addon">{!! trans('news::template.common.filterby') !!}:</span> -->
                    ...
                    <table class="new_table_desing table table-striped table-bordered table-hover table-checkable dataTable" id="datatable_ajax">
                        <thead>
                            <tr role="row" class="heading">
                                ...
                                <th width="15%" align="left">{{ trans('feedbacklead::template.common.name') }}</th>
                                <th width="15%" align="left">{{ trans('feedbacklead::template.common.email') }}</th>
                                <th width="13%" align="center">{{ trans('feedbacklead::template.common.phoneno') }}</th>
                                <th width="8%" align="center">{{ trans('feedbacklead::template.feedbackleadModule.satisfied') }}</th>
                                <th width="8%" align="center">{{ trans('feedbacklead::template.feedbackleadModule.visitfor') }}</th>
                                <th width="8%" align="center">{{ trans('feedbacklead::template.feedbackleadModule.category') }}</th>
                                <th width="8%" align="center">{{ trans('feedbacklead::template.feedbackleadModule.message') }}</th>
                                <th width="5%" align="center">{{ trans('feedbacklead::template.common.ip') }}</th>
                                <th width="20%" align="center">{{ trans('feedbacklead::template.common.received_date_time') }}</th>
                            </tr>
                        </thead>
                        <tbody></tbody>
                    </table>
                    @can('contact-us-delete')
                    <a href="javascript:;" class="btn-sm btn btn-outline red right_bottom_btn deleteMass">{{ trans('feedbacklead::template.common.delete') }}</a>
                    @endcan
                    <a href="#selectedRecords" class="btn-sm btn btn-green-drake right_bottom_btn ExportRecord" data-toggle="modal">{{ trans('feedbacklead::template.feedbackleadModule.export') }}</a>
                </div>
            </div>
            @else
        ...
        <div class="modal-vertical">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    {{ trans('feedbacklead::template.common.alert') }}
                </div>
                <div class="modal-body text-center">{{ trans('feedbacklead::template.feedbackleadModule.noExport') }} </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-green-drake" data-dismiss="modal">{{ trans('feedbacklead::template.common.ok') }}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-vertical">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">{{ trans('feedbacklead::template.feedbackleadModule.recordsExport') }}</div>
                <div class="modal-footer">
                    <div align="center">
                        <div class="md-radio-inline">
                            <div class="md-radio">
                                ...
                                <label for="selected_records">
                                    ...
                                    <span class="box"></span> {{ trans('feedbacklead::template.feedbackleadModule.selectedRecords') }}
                                </label>
                            </div>
                            <div class="md-radio">
                                ...
                                <label for="all_records">
                                    <span class="inc"></span>
                                    <span class="check"></span>
                                    <span class="box"></span>{{ trans('feedbacklead::template.feedbackleadModule.allRecords') }}
                                </label>
                            </div>
                        </div>
                    </div>
                    <button type="button" class="btn btn-green-drake" id="ExportRecord" data-dismiss="modal">{{ trans('feedbacklead::template.common.ok') }} </button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-vertical">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">{{ trans('feedbacklead::template.feedbackleadModule.leastRecord') }} </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-green-drake" data-dismiss="modal">{{ trans('feedbacklead::template.common.ok') }} </button>
                </div>
            </div>
...
<script src="{{ $CDN_PATH.'resources/pages/scripts/packages/feedbacklead/feedbacklead-datatables-ajax.js' }}" type="text/javascript"></script>
...
<script src="{{ $CDN_PATH.'resources/global/plugins/moment.min.js'}}" type="text/javascript"></script>
<script type="text/javascript">
