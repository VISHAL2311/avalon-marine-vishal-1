<div class="modal fade bd-example-modal-lg composer-element-popup ckeditor-popup ckbusiness-popup" id="sectionServiceModule" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel"><b>Add Service</b></h5>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="layoutType" class="form-control bootstrap-select bs-select" id="service-layout">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="col-md-4 col-sm-12">
                                            <select id="category-id" placeholder="Category" title="Category" class="form-control bootstrap-select bs-select"></select>
                                        </div>
                                        <div class="col-md-4 col-sm-12">
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <select multiple placeholder="Sort by" id="columns" title="Sort By" class="form-control bootstrap-select bs-select">
                                                <optgroup label="Fields" data-max-options="1">
                                                    <option selected value="varTitle">Title</option>
                                                </optgroup>
                                        ...
                                        <table class="responsive new_table_desing table table-striped table-bordered table-hover">
                                            <thead>
                                                <tr role="row" class="heading">
                                                    ...
                                                    <th width="20%" align="left">{{ trans('services::template.common.title') }}</th>
                                                    <th width="20%" align="center">{{ trans('services::template.common.category') }}</th>
                                                    <th width="20%" align="center">Image</th>
                                                </tr>
                                            </thead>
                                        </table>
                                        <div class="table-scrollable full-info-table" id="mcscroll" style="height: 200px">
                                            <table class="responsive new_table_desing table table-striped table-bordered table-hover table-checkable" id="datatable_services_ajax">
