...
<section class="work_list inner-page-container">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-6 col-sm-6 col-12 gap" data-aos="fade-up">
                <div class="work_box">
                    <div class="image img_hvr img-hvr_hvr">
                        <a href="{{ url('our-work') }}/{{ $workdata->alias->varAlias }}" title="{{ ucwords($workdata->varTitle) }}">
                            <div class="thumbnail-container">
                                <div class="thumbnail">
                                    <img class="lazy" data-src="{{ App\Helpers\resize_image::resize($workdata->fkIntImgId,640,286)}}" src="{{ App\Helpers\resize_image::resize($workdata->fkIntImgId,640,286)}}" alt="{{ htmlspecialchars_decode($workdata->varTitle) }}">
                                    <!-- <span class="mask">
