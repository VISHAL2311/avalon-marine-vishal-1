...
<div class="ac-modal modal fade bd-example-modal-lg composer-element-popup ckeditor-popup ckbusiness-popup" id="sectionBrandsModuleTemplate" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="ac-modal-table">
        <div class="ac-modal-center">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['method' => 'post','id'=>'frmSectionBrandsModuleTemplate']) !!}
                    ...
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="exampleModalLabel"><b>Brands</b></h5>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="form-group" style="display:none;">
                            ...
                            <select name="brandcat" class="form-control bootstrap-select bs-select layout-class" id="brand-template-layout">
                        ...
                        <div class="form-group" style="display:none;">
                            ...
                            {!! Form::text('brand_start_date_time', old('brand_start_date_time'), array('maxlength'=>'160','class' => 'form-control','id'=>'brand_start_date_time','autocomplete'=>'off')) !!}
                        </div>
                        <div class="form-group" style="display:none;">
                            <label class="control-label form_title">End Date</label>
                            {!! Form::text('brand_end_date_time', old('brand_end_date_time'), array('maxlength'=>'160','class' => 'form-control','id'=>'brand_end_date_time','autocomplete'=>'off')) !!}
                        </div>
                        <div class="form-group" style="display:none;">
                            <label class="control-label form_title">Limit (Note: All the brands will be shown if Limit not entered)</label>
