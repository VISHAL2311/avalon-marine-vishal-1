...
var TableDatatablesAjax = function () {
    var handleRecords = function () {
        ...
        grid.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                        ...
                        "data": 2,
                        className: 'text-left Brand_title_P_2 mob-show_div',
                        "name": 'varTitle',
                        "bSortable": true
                    }, 
                    // {
                    //     "data": 3,
                    //     "name": 'dtDateTime',
                    //     className: 'text-center Brand_sdate_P_4'
                    // }, {
                    //     "data": 4,
                    //     "name": 'dtEndDateTime',
                    //     className: 'text-center Brand_edate_P_5'
                    // }, 
                    {
                        "data": 3,
                        className: 'text-center Brand_order_P_6',
                        "name": 'intDisplayOrder'
                    }, {
                        "data": 4,
                        className: 'text-center publish_switch Brand_publish_P_7',
                        "bSortable": false
                    }, {
                        "data": 5,
                        className: 'text-right Brand_dactions_P_8 last_td_action mob-show_div',
                        "bSortable": false
                    }, {
                        "data": 6,
                        "visible": false,
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/brand/get_list", // ajax source
                },
        ...
        $(document).on('keyup', '#searchfilter', function (e) {
            ...
            if (action.length >= 2) {
                $.cookie('Brandsearch', action);
                grid.setAjaxParam("customActionType", "group_action");
                grid.setAjaxParam("searchValue", action);
                grid.setAjaxParam("id", grid.getSelectedRows());
                grid.getDataTable().ajax.reload();
            } else {
                $.removeCookie('Brandsearch');
                grid.setAjaxParam("customActionType", "group_action");
                grid.setAjaxParam("searchValue", action);
                grid.setAjaxParam("id", grid.getSelectedRows());
                grid.getDataTable().ajax.reload();
        ...
        grid1.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                        ...
                        "data": 1,
                        "name": 'varTitle',
                        className: 'text-left Brand_title_A_2 mob-show_div',
                        "bSortable": true
                    }, {
                        "data": 2,
                        className: 'text-center Brand_cat_A_3',
                        "name": 'intFKCategory'
                    }, {
                        "data": 3,
                        "name": 'dtDateTime',
                        className: 'text-center Brand_sdate_A_4'
                    }, {
                        "data": 4,
                        "name": 'dtEndDateTime',
                        className: 'text-center Brand_edate_A_5'
                    },  {
                        "data": 5,
                        className: 'text-right Brand_dactions_A_8 last_td_action mob-show_div',
                        "bSortable": false
                    }, {
                        "data": 6,
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/brand/get_list_New", // ajax source
                },
                'fnCreatedRow': function (nRow, aData, iDataIndex) {
                    $(nRow).attr('data-order', aData[6]);
                },
        ...
        grid2.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                        ...
                        "data": 1,
                        className: 'text-left Brand_title_D_2 mob-show_div',
                        "name": 'varTitle',
                        "bSortable": true
                    }, {
                        "data": 2,
                        className: 'text-center Brand_cat_D_3',
                        "name": 'intFKCategory'
                    }, {
                        "data": 3,
                        "name": 'dtDateTime',
                        className: 'text-center Brand_sdate_D_4'
                    }, {
                        "data": 4,
                        "name": 'dtEndDateTime',
                        className: 'text-center Brand_edate_D_5'
                    }, {
                        "data": 5,
                        className: 'text-center publish_switch Brand_publish_D_7',
                        "bSortable": false
                    }, {
                        "data": 6,
                        className: 'text-right Brand_dactions_D_8 last_td_action mob-show_div',
                        "bSortable": false
                    }, {
                        "data": 7,
                        className: 'text-center',
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/brand/get_list_draft", // ajax source
                },
                'fnCreatedRow': function (nRow, aData, iDataIndex) {
        ...
        grid3.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                        ...
                        "data": 1,
                        className: 'text-left Brand_title_T_2 mob-show_div',
                        "name": 'varTitle',
                        "bSortable": true
                    }, {
                        "data": 2,
                        className: 'text-center Brand_cat_T_3',
                        "name": 'intFKCategory'
                    }, {
                        "data": 3,
                        "name": 'dtDateTime',
                        className: 'text-center Brand_sdate_T_4'
                    }, {
                        "data": 4,
                        "name": 'dtEndDateTime',
                        className: 'text-center Brand_edate_T_5'
                    }, {
                        "data": 5,
                        className: 'text-right Brand_dactions_T_8 last_td_action mob-show_div',
                        "bSortable": false
                    }, {
                        "data": 6,
                        className: 'text-center',
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/brand/get_list_trash", // ajax source
                },
                'fnCreatedRow': function (nRow, aData, iDataIndex) {
                    $(nRow).attr('data-order', aData[6]);
                },
        ...
        grid4.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                        ...
                        "data": 2,
                        className: 'text-left Brand_title_F_2 mob-show_div',
                        "name": 'varTitle',
                        "bSortable": true
                    }, {
                        "data": 3,
                        className: 'text-center Brand_cat_F_3',
                        "name": 'intFKCategory'
                    }, {
                        "data": 4,
                        "name": 'dtDateTime',
                        className: 'text-center Brand_sdate_F_4'
                    }, {
                        "data": 5,
                        "name": 'dtEndDateTime',
                        className: 'text-center Brand_edate_F_5'
                    }, {
                        "data": 6,
                        className: 'text-right Brand_dactions_F_8 last_td_action mob-show_div',
                        "bSortable": false
                    }, {
                        "data": 7,
                        className: 'text-center',
                ...
                "ajax": {
                    "url": window.site_url + "/powerpanel/brand/get_list_favorite", // ajax source
                },
                'fnCreatedRow': function (nRow, aData, iDataIndex) {
                    $(nRow).attr('data-order', aData[7]);
                },
...
$(window).on('load', function () {
    if ($.cookie('Brandsearch')) {
        $('#searchfilter').val($.cookie('Brandsearch'));
...
function reorder(curOrder, excOrder) {
    var ajaxurl = site_url + '/powerpanel/brand/reorder';
    $.ajax({
        url: ajaxurl,
        data: {
            order: curOrder,
