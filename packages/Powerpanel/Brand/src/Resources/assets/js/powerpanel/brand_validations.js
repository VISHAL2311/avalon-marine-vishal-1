...
var Validate = function () {
    var handleCaionCatelogues = function () {
        $("#frmBrand").validate({
            ...
            messages: {
                title: {
                	required:Lang.get('validation.required', {attribute: Lang.get('template.question')})
                },
                // category_id: "Please select category.",
                description: "Answer field is required.",
                order: {
                ...
                end_date_time: {
                    required: Lang.get('validation.required', {attribute: Lang.get('End date')}),
        ...
        $('#frmBrand input').keypress(function (e) {
            if (e.which == 13) {
                if ($('#frmBrand').validate().form()) {
                    $('#frmBrand').submit();
                }
                return false;
            }
