                ...
                <div class="tab-pane active" id="general">
                  <div class="portlet-body form_pattern">
                    ...
                    <div class="form-body">
                      <div class="row">
                        <div class="col-md-12">
                          <div class="form-group @if($errors->first('title')) has-error @endif form-md-line-input">
                            ...
                            {!! Form::text('title', isset($service->varTitle)?$service->varTitle:old('title'), array('maxlength' => 50, 'class' => 'form-control hasAlias seoField maxlength-handler','autocomplete'=>'off','data-url' => 'powerpanel/services', 'placeholder' => 'Title')) !!}
                      ...
                      <!-- @include('powerpanel.partials.imageControl',['type' => 'single','label' => trans('services::template.common.selectimage') ,'data'=> isset($service)?$service:null , 'id' => 'service_image', 'name' => 'img_id', 'settings' => $settings, 'width' => '650', 'height' => '433']) -->
                      <div class="row">
                          <div class="col-md-12">
                            @if(isset($service->fkIntImgId) && ($service->fkIntImgId != $service->fkIntImgId))
                            ...
                            <div class="image_thumb multi_upload_images">
                              <div class="form-group">
                                <label class="form_title {{ $Class_fkIntImgId }}" for="front_logo">{{ trans('services::template.common.selectimage') }} <span aria-required="true" class="required"> * </span></label>
                                ...
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                  ...
                                  <div class="input-group">
                                    ...
                                    <input class="form-control" type="hidden" id="photo_album_image" name="img_id" value="{{ isset($service->fkIntImgId)?$service->fkIntImgId:old('img_id') }}" />
                                    @php
                                ...
                                <div class="clearfix"></div>
                                @php $height = isset($settings->height)?$settings->height:596; $width = isset($settings->width)?$settings->width:879; @endphp <span>{{ trans('services::template.common.imageSize',['height'=>$height, 'width'=>$width]) }}</span>
                              </div>
                              <span class="help-block">
                                {{ $errors->first('img_id') }}
                              </span>
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group @if($errors->first('short_description')) has-error @endif form-md-line-input">
                              ...
                              {!! Form::textarea('short_description', isset($service->txtShortDescription)?$service->txtShortDescription:old('short_description'), array('maxlength' => isset($settings->short_desc_length)?$settings->short_desc_length:400,'class' => 'form-control seoField maxlength-handler','id'=>'varShortDescription','rows'=>'3','placeholder' => 'Short Description')) !!}
                      ...
                      <div class="form-actions">
                        <div class="row">
                          <div class="col-md-12">
                            <button type="submit" name="saveandedit" class="btn btn-green-drake" value="saveandedit" title="{!! trans('services::template.common.saveandedit') !!}">{!! trans('services::template.common.saveandedit') !!}</button>
                            <button type="submit" name="saveandexit" class="btn btn-green-drake" value="saveandexit" title="{!! trans('services::template.common.saveandexit') !!}">{!! trans('services::template.common.saveandexit') !!}</button>
                            <a class="btn btn-outline red" href="{{ url('powerpanel/services') }}" title="{{ trans('services::template.common.cancel') }}">{{ trans('services::template.common.cancel') }}</a>
                          </div>
                        </div>
                      </div>
                      {!! Form::close() !!}
