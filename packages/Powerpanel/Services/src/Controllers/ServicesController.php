...
class ServicesController extends FrontController {
    ...
    public function index() {
        ...
        $paginate = 8;
        $services = Services::getFrontList($paginate);
    ...
    public function detail($alias) {
        ...
        if (!empty($service) || !empty($works)) {
            ...
            $data['txtDescription'] = FrontPageContent_Shield::renderBuilder($service->txtDescription,$service->id);
            $data['works'] = $works;
