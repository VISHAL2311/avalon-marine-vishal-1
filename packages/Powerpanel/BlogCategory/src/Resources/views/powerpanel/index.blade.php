...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="title-dropdown_sec">
            ...
            @include('powerpanel.partials.listbreadcrumbs',['ModuleName'=>'Blog Category'])
            @endif
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-12 col-xs-12">
                                <div class="portlet-lf-title">
                                    <div class="sub_select_filter" id="hidefilter">
                                        <span class="title">{!! trans('blogcategory::template.common.filterby') !!}:</span>
                                        <span class="select_input">
                                            <select id="statusfilter" data-sort data-order class="bs-select select2">
                                                <option value=" ">{!! trans('blogcategory::template.common.selectstatus') !!}</option>
                                                <option value="Y">{!! trans('blogcategory::template.common.publish') !!}</option>
                                                <option value="N">{!! trans('blogcategory::template.common.unpublish') !!}</option>
                                            </select>
                                        </span>   
                            ...
                            <div class="col-lg-6 col-md-12 col-xs-12">
                                <div class="portlet-rh-title">
                                    ...
                                    @if( isset(App\Helpers\MyLibrary::getFront_Uri('blog-category')['uri']) )
                                    <div class="add_category_button pull-right">
                                        <a class="add_category" href="{{ url('powerpanel/blog-category/add') }}"><span>{{ trans('blogcategory::template.blogCategoryModule.addBlogCategory') }}</span> <i class="la la-plus"></i></a>
                                    </div>
                                    @endif
                                    @endcan
                                </div>  
            ...
            <div class="portlet-body">
                <div class="table-container">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="row">
                            <div class="row col-md-6 col-sm-12 pull-right search_pages_div">
                                <div class="search_rh_div">
                                    <span>{{ trans('blogcategory::template.common.search') }}:</span>
                        ...
                        @endphp
                        @include('powerpanel.partials.datatable-view',['ModuleName'=>'BlogCategory','Permission_Delete'=>'blog-category-delete','tablearray'=>$tablearray,'userIsAdmin'=>$userIsAdmin,'Module_ID'=>Config::get('Constant.MODULE.ID')])
                </div>
            </div>
            <!-- Modal -->
            @if (File::exists(base_path() . '/resources/views/powerpanel/partials/quickeditpopup.blade.php') != null)
            @include('powerpanel.partials.quickeditpopup',['TableName'=>'blogCategory'])
            @endif
            @else
             @if (File::exists(base_path() . '/resources/views/powerpanel/partials/addrecordsection.blade.php') != null)
            @include('powerpanel.partials.addrecordsection',['type'=>Config::get('Constant.MODULE.TITLE'), 'adUrl' => url('powerpanel/blog-category/add')])
            @endif
            @endif
        </div>
    </div>
    ...
    <script type="text/javascript">
        window.site_url = '{!! url("/") !!}';
        var DELETE_URL = '{!! url("/powerpanel/blog-category/DeleteRecord") !!}';
        var rollbackRoute = window.site_url + "/powerpanel/blog-category/rollback-record";
        var APPROVE_URL = '{!! url("/powerpanel/blog-category/ApprovedData_Listing") !!}';
        var getChildData = window.site_url + "/powerpanel/blog-category/getChildData";
        var getChildData_rollback = window.site_url + "/powerpanel/blog-category/getChildData_rollback";
        var ApprovedData_Listing = window.site_url + "/powerpanel/blog-category/ApprovedData_Listing";
        var Get_Comments = window.site_url + "/powerpanel/blog-category/Get_Comments";
    ...
    <script src="{{ $CDN_PATH.'resources/pages/scripts/packages/blogcategory/blog-category-datatables-ajax.js' }}" type="text/javascript"></script>
