<div class="ac-modal modal fade bd-example-modal-lg composer-element-popup ckeditor-popup" id="sectionAboutblock" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="ac-modal-table">
        <div class="ac-modal-center">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['method' => 'post','id'=>'frmSectionAboutblock']) !!}
                    <input type="hidden" name="editing">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">
                            <span>×</span>
                        </button>
                        <h5 class="modal-title" id="exampleModalLabel"><b>About Block</b></h5>
                    </div>
                    <div class="modal-body">
                        @php $imgkey = 1; @endphp
                        <div class=" img_1" id="img1" style="display:none;">
                            <div class="team_box">
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::text('img_title', old('img_title'), array('maxlength'=>'160','class' => 'form-control imgip','id'=>'img_title','autocomplete'=>'off')) !!}
                        </div>

                        <div class="form-group">
                            <label class="control-label form_title">Tag Line<span aria-required="true" class="required"> * </span></label>
                            {!! Form::text('tagline', old('tagline'), array('maxlength'=>'160','class' => 'form-control imgip','id'=>'tagline','autocomplete'=>'off')) !!}
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label form_title">Button Title <span aria-required="true" class="required"> * </span></label>
                            {!! Form::text('buttontitle', old('buttontitle'), array('maxlength'=>'160','class' => 'form-control','id'=>'buttontitle','autocomplete'=>'off')) !!}
                        </div>
                        <div class="form-group">
                            <label class="control-label form_title">Button Link <span aria-required="true" class="required"> * </span></label>
                            {!! Form::text('buttonlink', old('buttonlink'), array('class' => 'form-control','id'=>'buttonlink','autocomplete'=>'off')) !!}
                        </div>

                        <div class="form-group imagealign" style="display:none;">
