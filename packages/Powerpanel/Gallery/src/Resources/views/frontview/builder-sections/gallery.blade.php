...
<section class="gallary_main gallary_sec">

    <div class="container-fuild" data-aos="fade-up">

        <h2 class="cm-title text-center">Explore Avalon Marine in Pictures</h2>

        <div class="grid gallary_slider owl-carousel owl-theme" data-aos="zoom-in">
