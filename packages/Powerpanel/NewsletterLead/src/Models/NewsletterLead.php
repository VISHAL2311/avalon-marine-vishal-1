...
{	
  ...
  public static function getRecordList($filterArr=false){
    $response = false;
    $moduleFields=[ 'id', 'varName','varEmail','VarToken','chrSubscribed','varIpAddress','chrPublish','created_at','updated_at'];
  ...
  public static function getListForExport($selectedIds=false){
    $response = false;
    $moduleFields=[ 'varName','varEmail','VarToken','chrSubscribed','chrPublish','varIpAddress','created_at'];
