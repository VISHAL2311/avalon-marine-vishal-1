...
class CreateBoatInquiryLeadTable extends Migration {
    ...
    public function up() {
        ...
        Schema::create('boatinquiry_lead', function (Blueprint $table) {

            $table->engine = 'InnoDB';
            $table->increments('id')->collation('utf8_general_ci');
            $table->unsignedInteger('fkIntBoatId')->collation('utf8_general_ci')->default(null);
