<div class="modal fade bd-example-modal-lg composer-element-popup ckeditor-popup ckbusiness-popup" id="sectionTestimonialModuleTemplate" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            {!! Form::open(['method' => 'post','id'=>'frmSectionTestimonialModuleTemplate']) !!}
            ...
            <div class="modal-body">
                ...
                <div class="form-group" style="display:none;">
                    ...
                    <select name="layoutType" class="form-control bootstrap-select bs-select" id="testimonial-template-layout">
