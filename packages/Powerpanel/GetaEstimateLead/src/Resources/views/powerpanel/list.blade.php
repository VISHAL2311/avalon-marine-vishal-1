...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="title-dropdown_sec">
            ...
            @include('powerpanel.partials.listbreadcrumbs',['ModuleName'=>'Manage Get Free Estimate Leads'])
            @endif
...
<!--                            <div class="col-lg-6 col-md-12 col-xs-12">
                                <div class="portlet-rh-title">
                                    <a class="btn btn-green-drake pull-right btn-rh-refresh" id="refresh" title="{!! trans('getaestimatelead::template.common.altResetFilters') !!}" href="javascript:;"><i class="fa fa-refresh"></i></a>
                                    <a class="btn btn-green-drake pull-right btn-rh-search " style="margin-right:15px;" id="getaestimateleadrange" href="javascript:;" title="{!! trans('getaestimatelead::template.common.search') !!}"><i class="fa fa-search"></i></a>
                    ...
                    <table class="new_table_desing table table-striped table-bordered table-hover table-checkable dataTable" id="datatable_ajax">
                        <thead>
                            <tr role="row" class="heading">
                                ...
                                <th width="12%" align="left">{{ trans('getaestimatelead::template.common.name') }}</th>							
                                <th width="15%" align="left">{{ trans('getaestimatelead::template.common.email') }}</th>
                                <th width="12%" align="center">{{ trans('getaestimatelead::template.common.phone') }}</th>
                                <th width="12%" align="left">{{ trans('Interested In') }}</th>
                                <th width="8%" align="center">{{ trans('getaestimatelead::template.getaestimateleadModule.message') }}</th>
                                <th width="9%" align="center">{{ trans('getaestimatelead::template.common.ip') }}</th>
                                <th width="15%" align="center">{{ trans('getaestimatelead::template.common.received_date_time') }}</th>
                            </tr>
                        </thead>
                        <tbody></tbody>
                    </table>				
                    @can('get-a-estimate-delete')
                    <a href="javascript:;" class="btn-sm btn btn-outline red right_bottom_btn deleteMass">{{ trans('getaestimatelead::template.common.delete') }}</a>
                    @endcan
                    <a href="#selectedRecords" class="btn-sm btn btn-green-drake right_bottom_btn ExportRecord" data-toggle="modal">{{ trans('getaestimatelead::template.getaestimateleadModule.export') }}</a>				
                </div>
            </div>
            @else
            @include('powerpanel.partials.addrecordsection',['marketlink' => 'https://www.netclues.com/social-media-marketing', 'type'=>'getaestimate'])
            @endif
        </div>
    </div>
</div>
        ...
        <div class="modal-vertical">	
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    {{ trans('getaestimatelead::template.common.alert') }} 
                </div>
                <div class="modal-body text-center">{{ trans('getaestimatelead::template.getaestimateleadModule.noExport') }} </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-green-drake" data-dismiss="modal">{{ trans('getaestimatelead::template.common.ok') }}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-vertical">	
            <div class="modal-content">
                ...
                <div class="modal-body text-center">{{ trans('getaestimatelead::template.getaestimateleadModule.recordsExport') }}</div>
                <div class="modal-footer">
                    <div align="center">
                        <div class="md-radio-inline">
                            <div class="md-radio">
                                ...
                                <label for="selected_records">
                                    ...
                                    <span class="box"></span> {{ trans('getaestimatelead::template.getaestimateleadModule.selectedRecords') }}
                                </label>
                            </div>
                            <div class="md-radio">
                                ...
                                <label for="all_records">
                                    <span class="inc"></span>
                                    <span class="check"></span>
                                    <span class="box"></span>{{ trans('getaestimatelead::template.getaestimateleadModule.allRecords') }} 
                                </label>
                            </div>
                        </div>
                    </div>
                    <button type="button" class="btn btn-green-drake" id="ExportRecord" data-dismiss="modal">{{ trans('getaestimatelead::template.common.ok') }} </button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-vertical">	
            <div class="modal-content">
                ...
                <div class="modal-body text-center">{{ trans('getaestimatelead::template.getaestimateleadModule.leastRecord') }} </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-green-drake" data-dismiss="modal">{{ trans('getaestimatelead::template.common.ok') }} </button>
                </div>
            </div>
...
<script type="text/javascript">
    window.site_url = '{!! url("/") !!}';
    var DELETE_URL = '{!! url("/powerpanel/get-a-estimate/DeleteRecord") !!}';
</script>
...
<script src="{{ url('resources/pages/scripts/packages/getaestimatelead/getaestimatelead-datatables-ajax.js') }}" type="text/javascript"></script>
