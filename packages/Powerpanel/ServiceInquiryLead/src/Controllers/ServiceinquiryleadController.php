...
namespace Powerpanel\ServiceInquiryLead\Controllers;
...
class ServiceinquiryleadController extends FrontController
{
    /**
    ...
    public function create()
    {
        ...
        return view('serviceinquirylead::frontview.service-inquiry', $data);
    }
    ...
    public function store()
    {
        ...
        $messsages = array(
            ...
            'phone_number.handle_xss' => 'Please enter valid input.',
                       'services.required' => "Please select intrested in.",
        ...
        if ($validator->passes()) {
            ...
            if (!empty($data['back_url'])) {
                ...
                return redirect()->back()->withErrors($validator)->withInput();
                // return Redirect::route('service-inquiry')->withErrors($validator)->withInput();
            }
        }
    }
}
