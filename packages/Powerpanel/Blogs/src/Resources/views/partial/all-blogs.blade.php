                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group" style="display:none;">
                         ...
                         <div class="form-group" style="display:none;">
                            ...
                            {!! Form::text('blogs_start_date_time', old('blogs_start_date_time'), array('maxlength'=>'160','class' => 'form-control','id'=>'blogs_start_date_time','autocomplete'=>'off')) !!}
                        </div>
                        <div class="form-group" style="display:none;">
                            <label class="control-label form_title">End Date</label>
                            {!! Form::text('blogs_end_date_time', old('blogs_end_date_time'), array('maxlength'=>'160','class' => 'form-control','id'=>'blogs_end_date_time','autocomplete'=>'off')) !!}
                        </div>
                         <div class="form-group" style="display:none;">
