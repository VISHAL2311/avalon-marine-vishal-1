...
return [
        ...
        */
		...
		Powerpanel\ServiceInquiryLead\Providers\ServiceInquiryLeadServiceProvider::class,
		Powerpanel\BoatInquiryLead\Providers\BoatInquiryLeadServiceProvider::class,
		...
		Powerpanel\BoatCategory\Providers\BoatCategoryServiceProvider::class,
		Powerpanel\Boat\Providers\BoatServiceProvider::class,
		Powerpanel\FaqCategory\Providers\FaqCategoryServiceProvider::class,
		Powerpanel\Faq\Providers\FaqServiceProvider::class,
		Powerpanel\Brand\Providers\BrandServiceProvider::class,
		Powerpanel\VideoGallery\Providers\VideoGalleryServiceProvider::class,
		Powerpanel\Work\Providers\WorkServiceProvider::class,
		Powerpanel\GetaEstimateLead\Providers\GetaEstimateLeadServiceProvider::class,
		Powerpanel\Gallery\Providers\GalleryServiceProvider::class,
		Powerpanel\DataRemovalLead\Providers\DataRemovalLeadServiceProvider::class,
