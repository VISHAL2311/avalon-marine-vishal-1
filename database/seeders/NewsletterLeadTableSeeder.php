...
class NewsletterLeadTableSeeder extends Seeder
{

    public function run()
    {
        $pageModuleCode = DB::table('module')->select('id')->where('varTitle', 'News Letter')->first();
        ...
        if (!isset($pageModuleCode->id) || empty($pageModuleCode->id)) {
            ...
            $pageModuleCode = DB::table('module')->where('varTitle', 'News Letter')->first();
            $permissions = [];
