											...
											<div class="row">
												<div class="col-md-12">
													...
													<div class="text-center">
														...
														<br/>
														<br/>
														<p><strong>Note:</strong> You can upload 15 images at one time and maximum upload file size is 15MB per image. Recommended image dimension is Width 2000px X Height 2000px.</p>
													</div>
												</div>
											</div>
            ...
            if (exif_imagetype($file->getPathName())) {
                ...
                if (isset($_REQUEST['folderid']) && $_REQUEST['folderid'] != '') {
                    ...
                    if ($this->BUCKET_ENABLED) {
                        ...
                        $file->move(public_path() . '/assets/images/' . $folderdata->foldername . '/', $name . '.' . $pathinfo['extension']);
//                        copy(public_path() . '/assets/images/' . $folderdata->foldername . '/'. $name . '.' . $pathinfo['extension'],public_path() . '/assets/images/'. $name . '.' . $pathinfo['extension']);
                    }
    ...
    public function cropImage() {
        ...
        if ($imageObj->varfolder == 'folder') {
            $imageURL = url('/assets/images/' . $folderObj->foldername) . '/' . $imageObj->txtImageName . '.' . $imageObj->varImageExtension;
        } else {
            $imageURL = url('/assets/images') . '/' . $imageObj->txtImageName . '.' . $imageObj->varImageExtension;
        }
    ...
    public function saveCroppedImage() {
        ...
        if (!empty($imageObj)) {
            ...
            if ($overwrite == 'true') {
                ...
                if ($imageObj->varfolder == 'folder') {
                    $path = public_path() . '/assets/images/' . $folderObj->foldername . '/' . $name . '.' . $extension;
                } else {
                    $path = public_path() . '/assets/images/' . $name . '.' . $extension;
                }
...
//				exit;
                ...
                foreach ($recently_uploaded as $key => $value) {
                    ...
                    if ($this->BUCKET_ENABLED) {
                        ...
                        if (!empty($folderdata) && isset($value->varfolder) && $value->varfolder == 'folder') {
                            $img_path = public_path() . '/assets/images/' . $folderdata->foldername . '/' . $value->txtImageName . '.' . $value->varImageExtension;
                        } else {
                            $img_path = public_path() . '/assets/images/' . $value->txtImageName . '.' . $value->varImageExtension;
                        }
                    }
                    if (!empty($folderdata) && isset($value->varfolder) && $value->varfolder == 'folder') {
                        $imageurl = url('/assets/images/' . $folderdata->foldername . '/' . $value->txtImageName . '.' . $value->varImageExtension);
                    } else {
                ...
                if (!empty($filename)) {
                    ...
                    if (isset($pathinfo['extension'])) {
                        if ($pathinfo['extension'] == "jpg" || $pathinfo['extension'] == "jpeg" || $pathinfo['extension'] == "png" || $pathinfo['extension'] == "gif") {
                            ...
                            file_put_contents(public_path() . '/assets/images/' . $name . '.' . $pathinfo['extension'], file_get_contents(Request::get('url')));
            ...
            foreach ($imageObj as $key => $value) {
                ...
                if ($this->filePathExist($img_path)) {
                    if ($this->BUCKET_ENABLED) {
                        ...
                        $img_main_src = url('/assets/images/' . $value->txtImageName . '.' . $value->varImageExtension);
                    }
    ...
    function GetFolderImages() {
        ...
        foreach ($folder_data as $fdata) {
            ...
            $img_path = url('/assets/images/' . $folderdata->foldername . '/' . $fdata->txtImageName . '.' . $fdata->varImageExtension);
