...
{	
	...
	public function banners(){
		return $this->hasOne('Powerpanel\Banner\Models\Banner','id','fkIntVideoId');
	}
...
/**
  ...
  public static function getVideoDataForSingleVidoe($id=false){
	$response=false;
	 $moduleFields=['id','varVideoName','txtVideoOriginalName','varVideoExtension','youtubeId','vimeoId'];
	 $response = Self::select($moduleFields)
	 ->deleted()
	 ->where('id',$id)
	 ->first();
