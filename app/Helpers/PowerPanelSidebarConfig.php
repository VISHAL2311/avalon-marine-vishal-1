...
class PowerPanelSidebarConfig {
    ...
    public static function getConfig() {
        ...
        if (Auth::user()->can('workflow-list')) {
        ...
        if (Auth::user()->can('service-inquiry-list')) {
            $menuArr['can-service-inquiry-list'] = true;
            if (Request::segment(2) == 'service-inquiry') {
                $menuArr['serviceinquiry_active'] = 'active';
                $menuArr['serviceinquiry_open'] = 'open';
                $menuArr['serviceinquiry_selected'] = 'selected';
                $menuArr['leadmg'] = 'active';
            } else {
                $menuArr['serviceinquiry_active'] = '';
                $menuArr['serviceinquiry_open'] = '';
                $menuArr['serviceinquiry_selected'] = '';
            }
        }
        if (Auth::user()->can('boat-inquiry-list')) {
            $menuArr['can-boat-inquiry-list'] = true;
            if (Request::segment(2) == 'boat-inquiry') {
                $menuArr['boatinquiry_active'] = 'active';
                $menuArr['boatinquiry_open'] = 'open';
                $menuArr['boatinquiry_selected'] = 'selected';
                $menuArr['leadmg'] = 'active';
            } else {
                $menuArr['boatinquiry_active'] = '';
                $menuArr['boatinquiry_open'] = '';
                $menuArr['boatinquiry_selected'] = '';
            }
        }
        if (Auth::user()->can('get-a-estimate-list')) {
            $menuArr['can-get-a-estimate-list'] = true;
            if (Request::segment(2) == 'get-a-estimate') {
                $menuArr['getaestimate_active'] = 'active';
                $menuArr['getaestimate_open'] = 'open';
                $menuArr['getaestimate_selected'] = 'selected';
                $menuArr['leadmg'] = 'active';
            } else {
                $menuArr['getaestimate_active'] = '';
                $menuArr['getaestimate_open'] = '';
                $menuArr['getaestimate_selected'] = '';
            }
        }

        if (Auth::user()->can('feedback-leads-list')) {
        ...
        if (Auth::user()->can('data-removal-lead-list')) {
            $menuArr['can-data-removal-lead-list'] = true;
            if (Request::segment(2) == 'data-removal-lead') {
                $menuArr['dataremoval_active'] = 'active';
                $menuArr['dataremoval_open'] = 'open';
                $menuArr['dataremoval_selected'] = 'selected';
                $menuArr['leadmg'] = 'active';
            } else {
                $menuArr['dataremoval_active'] = '';
                $menuArr['dataremoval_open'] = '';
                $menuArr['dataremoval_selected'] = '';
            }
        }
        ...
        if (Auth::user()->can('gallery-list')) {
            $menuArr['can-gallery-list'] = true;
            if (Request::segment(2) == 'gallery') {
                $menuArr['gallery_active'] = 'active';
                $menuArr['gallery_open'] = 'open';
                $menuArr['gallery_selected'] = 'selected';
                $menuArr['gallerymg'] = 'active';
                $menuArr['sitemgopen'] = 'active';
            } else {
                $menuArr['gallery_active'] = '';
                $menuArr['gallery_open'] = '';
                $menuArr['gallery_selected'] = '';
            }
        }
...
//			if(Auth::user()->hasRole('netquick_admin') || !$userIsAdmin){
        ...
        if (Auth::user()->can('onlinepollingcategory-list')) {
            $menuArr['can-onlinepollingcategory-list'] = true;
            if (Request::segment(2) == 'onlinepollingcategory') {
                $menuArr['onlinepollingcategory_active'] = 'active';
                $menuArr['onlinepollingcategory_open'] = 'open';
                $menuArr['onlinepollingcategory_selected'] = 'selected';
                $menuArr['onlinepollingmg'] = 'active';
                $menuArr['contmg'] = 'active';
            } else {
                $menuArr['onlinepollingcategory_active'] = '';
                $menuArr['onlinepollingcategory_open'] = '';
                $menuArr['onlinepollingcategory_selected'] = '';
            }
        }
        if (Auth::user()->can('onlinepolling-list')) {
            $menuArr['can-onlinepolling-list'] = true;
            if (Request::segment(2) == 'onlinepolling') {
                $menuArr['onlinepolling_active'] = 'active';
                $menuArr['onlinepolling_open'] = 'open';
                $menuArr['onlinepolling_selected'] = 'selected';
                $menuArr['onlinepollingmg'] = 'active';
                $menuArr['contmg'] = 'active';
            } else {
                $menuArr['onlinepolling_active'] = '';
                $menuArr['onlinepolling_open'] = '';
                $menuArr['onlinepolling_selected'] = '';
            }
        }
        ...
        if (Auth::user()->can('boat-category-list')) {
            $menuArr['can-boats-category-list'] = true;
            if (Request::segment(2) == 'boat-category') {
                $menuArr['boat_category_active'] = 'active';
                $menuArr['boat_category_open'] = 'open';
                $menuArr['boat_category_selected'] = 'selected';
                $menuArr['sertmg'] = 'active';
                $menuArr['contmg'] = 'active';
            } else {
                $menuArr['boat_category_active'] = '';
                $menuArr['boat_category_open'] = '';
                $menuArr['boat_category_selected'] = '';
            }
        }
       
        if (Auth::user()->can('boat-list')) {
            
            $menuArr['can-boats-list'] = true;
            if (Request::segment(2) == 'boat') {
                $menuArr['boat_active'] = 'active';
                $menuArr['boat_open'] = 'open';
                $menuArr['boat_selected'] = 'selected';
                $menuArr['sertmg'] = 'active';
                $menuArr['contmg'] = 'active';
            } else {
                $menuArr['boat_active'] = '';
                $menuArr['boat_open'] = '';
                $menuArr['boat_selected'] = '';
            }
        }
        ...
        if (Auth::user()->can('work-list')) {
            $menuArr['can-work-list'] = true;
            if (Request::segment(2) == 'work') {
                $menuArr['work_active'] = 'active';
                $menuArr['work_open'] = 'open';
                $menuArr['work_selected'] = 'selected';
                $menuArr['sitemg'] = 'active';
                $menuArr['sitemgopen'] = 'open';
            } else {
                $menuArr['work_active'] = '';
                $menuArr['work_open'] = '';
                $menuArr['work_selected'] = '';
            }
        }
        ...
        if (Auth::user()->can('brand-list')) {
            $menuArr['can-brand-list'] = true;
            if (Request::segment(2) == 'brand') {
                $menuArr['brand_active'] = 'active';
                $menuArr['brand_open'] = 'open';
                $menuArr['brand_selected'] = 'selected';
                $menuArr['sitemg'] = 'active';
                $menuArr['sitemgopen'] = 'open';
            } else {
                $menuArr['brand_active'] = '';
                $menuArr['brand_open'] = '';
                $menuArr['brand_selected'] = '';
            }
        }
...
//			}
        ...
        if (Auth::user()->can('media-manager-list')) {
