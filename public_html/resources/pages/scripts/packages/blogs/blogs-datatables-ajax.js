...
var TableDatatablesAjax = function () {
    var handleRecords = function () {
        ...
        grid.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                        ...
                        "data": 2,
                        className: 'text-left mob-show_div Blogs_title_P_2',
                        "name": 'varTitle',
                        "bSortable": true
                    }, 
                    // {
                    //     "data": 3,
                    //     className: 'text-center Blogs_cat_P_3',
                    //     "name": 'intFKCategory'
                    // }, 
                    {
                        "data": 3,
                        className: 'text-center Blogs_image_P_4',
                        "bSortable": false
                    }, {
                        "data": 4,
                        "name": 'dtDateTime',
                        className: 'text-center Blogs_sdate_P_5'
                    }, {
                        "data": 5,
                        "name": 'dtEndDateTime',
                        className: 'text-center Blogs_edate_P_6'
                    }, {
                        "data": 6,
                        className: 'text-center Blogs_hits_P_7',
                        "bSortable": false
                    }, {
                        "data": 7,
                        className: 'text-center publish_switch Blogs_publish_P_8',
                        "bSortable": false
                    }, {
                        "data": 8,
                        className: 'text-right last_td_action mob-show_div Blogs_dactions_P_9',
                        "bSortable": false
                    }],
                "ajax": {
                    "url": window.site_url + "/powerpanel/blogs/get_list", // ajax source
                },
        ...
        $(document).on('keyup', '#searchfilter', function (e) {
            ...
            if (action.length >= 2) {
                $.cookie('Blogssearch', action);
                grid.setAjaxParam("customActionType", "group_action");
                grid.setAjaxParam("searchValue", action);
                grid.setAjaxParam("id", grid.getSelectedRows());
                grid.getDataTable().ajax.reload();
            } else {
                $.removeCookie('Blogssearch');
                grid.setAjaxParam("customActionType", "group_action");
                grid.setAjaxParam("searchValue", action);
                grid.setAjaxParam("id", grid.getSelectedRows());
                grid.getDataTable().ajax.reload();
        ...
        grid1.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                        ...
                        "data": 1,
                        "name": 'varTitle',
                        className: 'text-center mob-show_div Blogs_title_A_2',
                        "bSortable": true
                    }, {
                        "data": 2,
                        className: 'text-center Blogs_cat_A_3',
                        "name": 'intFKCategory'
                    }, {
                        "data": 3,
                        className: 'text-center Blogs_image_A_4',
                        "bSortable": false
                    }, {
                        "data": 4,
                        className: 'text-center Blogs_sdate_A_5',
                        "name": 'dtDateTime',
                        "bSortable": true
                    }, {
                        "data": 5,
                        "name": 'dtEndDateTime Blogs_edate_A_6',
                        className: 'text-center'
                    }, {
                        "data": 6,
                        className: 'text-center Blogs_hits_A_7'
                    },  {
                        "data": 7,
                        className: 'text-right last_td_action mob-show_div Blogs_dactions_A_9',
                        "bSortable": false
                    }],
                "ajax": {
                    "url": window.site_url + "/powerpanel/blogs/get_list_New", // ajax source
                },
                'fnCreatedRow': function (nRow, aData, iDataIndex) {
        ...
        grid2.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                        ...
                        "data": 1,
                        className: 'text-left mob-show_div Blogs_title_D_2',
                        "name": 'varTitle',
                        "bSortable": true
                    }, {
                        "data": 2,
                        className: 'text-center Blogs_cat_D_3',
                        "name": 'intFKCategory'
                    }, {
                        "data": 3,
                        className: 'text-center Blogs_image_D_4',
                        "bSortable": false
                    }, {
                        "data": 4,
                        "name": 'dtDateTime',
                        className: 'text-center Blogs_sdate_D_5'
                    }, {
                        "data": 5,
                        "name": 'dtEndDateTime',
                        className: 'text-center Blogs_edate_D_6'
                    }, {
                        "data": 6,
                        className: 'text-center Blogs_hits_D_7',
                        "bSortable": false
                    }, {
                        "data": 7,
                        className: 'text-center publish_switch Blogs_publish_D_8',
                        "bSortable": false
                    }, {
                        "data": 8,
                        className: 'text-right last_td_action mob-show_div Blogs_dactions_D_9',
                        "bSortable": false
                    }],
                "ajax": {
                    "url": window.site_url + "/powerpanel/blogs/get_list_draft", // ajax source
                },
                'fnCreatedRow': function (nRow, aData, iDataIndex) {
                    //$(nRow).attr('data-order', aData[10]);
                },
        ...
        grid3.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                        ...
                        "data": 1,
                        className: 'text-left mob-show_div Blogs_title_T_2',
                        "name": 'varTitle',
                        "bSortable": true
                    }, {
                        "data": 2,
                        className: 'text-center Blogs_cat_T_3',
                        "name": 'intFKCategory'
                    }, {
                        "data": 3,
                        className: 'text-center Blogs_image_T_4',
                        "bSortable": false
                    }, {
                        "data": 4,
                        "name": 'dtDateTime',
                        className: 'text-center Blogs_sdate_T_5'
                    }, {
                        "data": 5,
                        "name": 'dtEndDateTime',
                        className: 'text-center Blogs_edate_T_6'
                    }, {
                        "data": 6,
                        className: 'text-center Blogs_hits_T_7',
                        "bSortable": false
                    }, {
                        "data": 7,
                        className: 'text-right last_td_action mob-show_div Blogs_dactions_T_9',
                        "bSortable": false
                    }],
                "ajax": {
                    "url": window.site_url + "/powerpanel/blogs/get_list_trash", // ajax source
                },
                'fnCreatedRow': function (nRow, aData, iDataIndex) {
                    //$(nRow).attr('data-order', aData[10]);
                },
        ...
        grid4.init({
            ...
            dataTable: {// here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "columns": [{
                        ...
                        "data": 2,
                        className: 'text-left mob-show_div Blogs_title_F_2',
                        "name": 'varTitle',
                        "bSortable": true
                    }, {
                        "data": 3,
                        className: 'text-center Blogs_title_F_2 ',
                        "name": 'intFKCategory'
                    }, {
                        "data": 4,
                        className: 'text-center Blogs_image_F_4',
                        "bSortable": false
                    }, {
                        "data": 5,
                        "name": 'dtDateTime',
                        className: 'text-center Blogs_sdate_F_5'
                    }, {
                        "data": 6,
                        "name": 'dtEndDateTime',
                        className: 'text-center Blogs_edate_F_6'
                    }, {
                        "data": 7,
                        className: 'text-center Blogs_hits_F_7',
                        "bSortable": false
                    }, {
                        "data": 8,
                        className: 'text-right last_td_action mob-show_div Blogs_dactions_F_9',
                        "bSortable": false
                    }],
                "ajax": {
                    "url": window.site_url + "/powerpanel/blogs/get_list_favorite", // ajax source
                },
                'fnCreatedRow': function (nRow, aData, iDataIndex) {
                    //$(nRow).attr('data-order', aData[10]);
                },
...
$(window).on('load', function () {
    if ($.cookie('Blogssearch')) {
        $('#searchfilter').val($.cookie('Blogssearch'));
...
function reorder(curOrder, excOrder) {
    var ajaxurl = site_url + '/powerpanel/blogs/reorder';
    $.ajax({
        url: ajaxurl,
        data: {
            order: curOrder,
