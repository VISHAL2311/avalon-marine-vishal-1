var TableDatatablesAjax = function () {
	var initPickers = function () {
		...
		$(document).on('click', '#contactleadrange', function (e) {
            e.preventDefault();
            var action = {};
	...
	var handleRecords = function () {
        ...
        "stateSave": true, // save datatable state(pagination, sort, etc) in cookie.
				...
				"columns": [
					...
					{"data": 3, className: 'text-center',"bSortable":false,"name":'varReason'},
					{"data": 4, className: 'text-center',"bSortable":false,"name":'varRequeststatus'},
				...
				"ajax": {
					"url": window.site_url+"/powerpanel/data-removal-lead/get_list", // ajax source
				},
				"order": [
					[7, "desc"]
					...
					if (exportRadioVal == 'selected_records') {
						if ($('#ExportRecord').click) {
							if ($('input[name="delete[]"]:checked').val()) {
								...
								var ajaxurl = window.site_url+"/powerpanel/data-removal-lead/ExportRecord"+ip;
						...
						var ajaxurl = window.site_url+"/powerpanel/data-removal-lead/ExportRecord";
						window.location = ajaxurl;
					}
				}
			}
