/**
 * This method validates work form fields
 * since   2016-12-24
 * author  NetQuick
 */
 var Validate = function() {
		var handleWork = function() {
				...
				$('#frmWork input').on('keypress',function(e) {
						if (e.which == 13) {
								if ($('#frmWork').validate().form()) {
										$('#frmWork').submit(); //form validation success, call ajax form submit
										$("button[type='submit']").attr('disabled','disabled');
								}
								return false;
						}
