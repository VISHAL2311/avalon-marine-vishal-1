        ...
        grid.init({
            ...
            dataTable: {
                ...
                "columns": [
                    ...
                    { "data": 3, 'bSortable': false, 'name': 'varBannerType', className: 'text-center Banners_bannertype_P_4' },
                    { "data": 4, 'bSortable': false, className: 'text-center Banners_page_P_5' },
                    // {
                    //     "data": 6,
                    ...
                    //     "bSortable": true
                    // },
                    // { "data": 7, 'bSortable': false, className: 'text-center Banners_rotatetime_P_7', 'name': 'varRotateTime' },
                    { "data": 5, className: 'text-center Banners_displayorder_P_8', 'name': 'intDisplayOrder' },
                    { "data": 6, 'bSortable': false, className: 'text-center publish_switch Banners_publish_P_9' },
                    { "data": 7, 'bSortable': false, className: 'text-right Banners_dactions_P_10 last_td_action mob-show_div' },
                ],
                "columnDefs": [{
                    "targets": [7],
                    "searchable": false
        ...
        grid1.init({
            ...
            dataTable: {
                ...
                "columns": [{
                    ...
                    { "data": 6, 'bSortable': false, 'name': 'varRotateTime', className: 'text-center Banners_rotatetime_A_7' },

                    { "data": 7, 'bSortable': false, className: 'text-right Banners_dactions_A_10 last_td_action mob-show_div' },
        ...
        grid2.init({
            ...
            dataTable: {
                ...
                "columns": [{
                    ...
                    { "data": 6, 'bSortable': false, className: 'text-center publish_switch Banners_publish_D_9' },
                    { "data": 7, 'bSortable': false, className: 'text-right Banners_dactions_D_10 last_td_action mob-show_div' }
                ],
                "columnDefs": [{
        ...
        grid3.init({
            ...
            dataTable: {
                ...
                "columns": [
                    ...
                    { "data": 6, 'bSortable': false, className: 'text-right Banners_dactions_T_10 last_td_action mob-show_div' },
                ],
                "columnDefs": [{
        ...
        grid4.init({
            ...
            dataTable: {
                ...
                "columns": [
                    ...
                    { "data": 7, 'bSortable': false, className: 'text-right Banners_dactions_F_10 last_td_action mob-show_div' },
                ],
                "columnDefs": [{
                    "targets": [8],
                    "visible": false,
