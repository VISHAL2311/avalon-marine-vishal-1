    ...
    return {
        ...
        fillFormObj: function () {
            ...
            $('.section-item').each(function () {
                ...
                if ($(this).hasClass('img-rt-area')) {
                ...
                } else if ($(this).hasClass('about-img-rt-area')) {
                    var img = $(this).find('.imgip').data('id');
                    var caption = $(this).find('.imgip').data('caption');
                    var txt = $(this).find('.imgip').val();
                    var align = $(this).find('.imgip').data('type');
                    ...
                    var buttontitle = $(this).find('.imgip').data('buttontitle');
                    var buttonlink = $(this).find('.imgip').data('buttonlink');
                    var tagline = $(this).find('.imgip').data('tagline');
...
//                        var txt = $('.two_col_2').closest('div[data-editor=' + editior + ']').find('.onlytitleclass').val();
                ...
                } else if ($(this).hasClass('boatTemplate')) {
                    var caption = $(this).find('.txtip').val();
                    var conf = $(this).find('.txtip').data('config');
                    var type = $(this).find('.txtip').data('type');
                    var layoutType = $(this).find('input[type=hidden]').data('layout');
                ...
                } else if ($(this).hasClass('workTemplate')) {
                    var caption = $(this).find('.txtip').val();
                    var conf = $(this).find('.txtip').data('config');
                    var type = $(this).find('.txtip').data('type');
                    var layoutType = $(this).find('input[type=hidden]').data('layout');
        ...
        blogsTemplate: function (val, sectionlimit, sectiondesc, config, template, edit, configTxt, layout,extra_class,startdate,enddate,blogscat) {
            ...
            if (edit == 'N') {
                ...
                section += '<div class="clearfix"></div>';
                var elementsarr = $('#section-container').find('div[data-editor=' + edit + ']');
                elementsarr.each(function(){
                    if( $(this).hasClass('blogsTemplate')) {
                        $(this).html(section);
                    } 
                });
            }
...
//                $('#section-container').find('div[data-editor=' + edit + ']').html(section);
        ...
        addAboutblock: function (imgsrc, val, imgCaption, content, type, edit,folderid, buttontitle, buttonlink, tagline) {
            var iCount = 'item-' + ($('.ui-state-default').length + 1);
            if ($('.add-element').hasClass('clicked')) {
                var section = '';
                var content1 = content.replace(new RegExp(String.fromCharCode(34), 'g'), '&#34;');
                ...
                // section += '<div class="thumbnail">';
                // section += '<img src="' + imgsrc + '">';
                section += '<input id="' + edit + '" data-id="' + val + '" data-type="' + type + '" data-folderid="'+folderid+'" data-caption="' + imgCaption + '" data-tagline="' + tagline + '" data-buttontitle="' + buttontitle + '" data-buttonlink="' + buttonlink + '" type="hidden" class="imgip imgcontentclass" value="' + content1 + '"/>';
                // section += '</div>';
                // section += '</div>';
                // section += '</div>';
                section += '<div class="title-img">';
                ...
                $('.add-element.clicked').parents('.maintwocol').find('.twocol1').html(section);
                $('.add-element.clicked').parents('.maintwocol').find('.hidecol').hide();
                $('.add-element.clicked').parents('.col_1').find('.columnstwo').addClass('about-block');
            } else {
                var section = '';
                var content1 = content.replace(new RegExp(String.fromCharCode(34), 'g'), '&#34;');
                if (edit == 'N') {
                    ...
                    section += '<i class="action-icon delete fa fa-trash"></i>';
                    section += '</a>';
                    section += '<a href="javascript:;" title="Edit" data-id="' + iCount + '" class="about-block hideclass">';
                    section += '<i class="action-icon edit fa fa-pencil"></i>';
                    section += '</a>';
                    section += '<div class="clearfix"></div>';
                    section += '<div class="section-item  about-img-rt-area" data-editor="' + iCount + '">';
                    section += '<div class="col-md-12 col-xs-small">';
                    // section += '<div class="team_box">';
                    // section += '<div class="thumbnail_container">';
                    // section += '<div class="thumbnail">';
                    // section += '<img src="' + imgsrc + '">';
                    section += '<input id="' + iCount + '" data-id="' + val + '" data-type="' + type + '" data-folderid="'+folderid+'" data-caption="' + imgCaption + '" data-tagline="' + tagline + '" data-buttontitle="' + buttontitle + '" data-buttonlink="' + buttonlink + '" type="hidden" class="imgip" value="' + content1 + '"/>';
                    // section += '</div>';
                    // section += '</div>';
                    // section += '</div>';
                    section += '<div class="title-img">';
                    ...
                    // section += '<div class="thumbnail">';
                    // section += '<img src="' + imgsrc + '">';
                    section += '<input id="' + edit + '" data-id="' + val + '" data-type="' + type + '" data-folderid="'+folderid+'" data-caption="' + imgCaption + '" data-tagline="' + tagline + '" data-buttontitle="' + buttontitle + '" data-buttonlink="' + buttonlink + '" type="hidden" class="imgip" value="' + content1 + '"/>';
                    // section += '</div>';
                    // section += '</div>';
                    // section += '</div>';
                    section += '<div class="title-img">';
            ...
            if ($('.add-element').hasClass('clicked')) {
                ...
                if (edit == 'N') {
                    ...
                    $.each(images, function (index, value) {
                        section += '<li data-id="' + index + '" id="' + index + '-item-' + iCount + '"><img height="50" width="50" src="' + value + '"/><a href="javascript:;" class="close-icon" title="Delete"><i class="fa fa-times" aria-hidden="true"></i></a></li>';
                    });
                    section += '</ul>';
                    section += '</div>';
        ...
        moduleSectionsEvents: function (caption, desc, config, configTxt, recids, recTitle, edit, template, layoutType,extraclass) {
            ...
            if (edit == 'N') {
                ...
                $.each(eventsIds, function (index, value) {
                    section += '<li data-customized="' + eventsCustomized[index] + '" data-img="' + eventsImg[index] + '" data-imgsrc="' + eventsImgSrc[index] + '" data-imgheight="' + eventsImgheight[index] + '" data-imgwidth="' + eventsImgwidth[index] + '" data-imgpoint="' + eventsImgpoint[index] + '" data-phone="' + eventsPhone[index] + '" data-email="' + eventsEmail[index] + '" data-website="' + eventsWebsite[index] + '" data-address="' + eventsAddress[index] + '" data-description="' + eventsDescription[index] + '" data-id="' + value + '" id="' + value + '-item-' + edit + '">' + eventsTitles[index]  + '<a href="javascript:;" class="close-icon" title="Delete"><i class="fa fa-times" aria-hidden="true"></i></a></li>';
                });
                section += '</ul>';
        ...
        moduleSectionsPromotions: function (caption, config, configTxt, recids, recTitle, edit, template, layoutType) {
            ...
            if (edit == 'N') {
                ...
                $.each(promotionsIds, function (index, value) {
                    section += '<li data-customized="' + promotionsCustomized[index] + '" data-img="' + promotionsImg[index] + '" data-imgsrc="' + promotionsImgSrc[index] + '" data-imgheight="' + promotionsImgheight[index] + '" data-imgwidth="' + promotionsImgwidth[index] + '" data-imgpoint="' + promotionsImgpoint[index] + '" data-phone="' + promotionsPhone[index] + '" data-email="' + promotionsEmail[index] + '" data-website="' + promotionsWebsite[index] + '" data-address="' + promotionsAddress[index] + '" data-description="' + promotionsDescription[index] + '" data-id="' + value + '" id="' + value + '-item-' + edit + '">' + promotionsTitles[index]  + '<a href="javascript:;" class="close-icon" title="Delete"><i class="fa fa-times" aria-hidden="true"></i></a></li>';
                });
                section += '</ul>';
        ...
        moduleSectionsNews: function (caption, desc, config, configTxt, recids, recTitle, edit, template, layoutType,extraclass) {
            ...
            if (edit == 'N') {
                ...
                $.each(newsIds, function (index, value) {
                    section += '<li data-id="' + value + '" id="' + value + '-item-' + edit + '">' + newsTitles[index] + '<a href="javascript:;" class="close-icon" title="Delete"><i class="fa fa-times" aria-hidden="true"></i></a></li>';
                });
                section += '</ul>';
        ...
        moduleSectionsAlerts: function (caption, recids, recTitle, edit, template,extraclass) {
            ...
            if (edit == 'N') {
                ...
                $.each(alertsIds, function (index, value) {
                    section += '<li data-id="' + value + '" id="' + value + '-item-' + edit + '">' + alertsTitles[index] +  '<a href="javascript:;" class="close-icon" title="Delete"><i class="fa fa-times" aria-hidden="true"></i></a></li>';
                });
                section += '</ul>';
        ...
        moduleSectionsLinks: function (caption, recids, recTitle, edit, template,extraclass) {
            ...
            if (edit == 'N') {
                ...
                $.each(linksIds, function (index, value) {
                    section += '<li data-id="' + value + '" id="' + value + '-item-' + edit + '">' + linksTitles[index] +  '<a href="javascript:;" class="close-icon" title="Delete"><i class="fa fa-times" aria-hidden="true"></i></a></li>';
                });
                section += '</ul>';
        ...
        moduleSectionsFaqs: function (caption, recids, recTitle, edit, template,extraclass) {
         ...
         addIframe: function(val, extClass, edit) {
            ...
            if (edit == 'N') {
                ...
                section += '<div class="col-md-12"><label><b>Iframe</b></label><br/>' + val + '</div>';
        ...
        moduleSectionsDepartment: function (caption, recids, recTitle, edit, template,extraclass) {
            ...
            if (edit == 'N') {
                ...
                $.each(departmentIds, function (index, value) {
                    section += '<li data-id="' + value + '" id="' + value + '-item-' + edit + '">' + departmentTitles[index]  + '<a href="javascript:;" class="close-icon" title="Delete"><i class="fa fa-times" aria-hidden="true"></i></a></li>';
                });
                section += '</ul>';
        ...
        moduleSectionsArticles: function (caption, config, configTxt, recids, recTitle, edit, template, layoutType, featuredRestaurant) {
            ...
            if (edit == 'N') {
                ...
                $.each(articlesIds, function (index, value) {
                    section += '<li data-id="' + value + '" id="' + value + '-item-' + edit + '">' + articlesTitles[index] + '<a href="javascript:;" class="close-icon" title="Delete"><i class="fa fa-times" aria-hidden="true"></i></a></li>';
                });
                section += '</ul>';
        ...
        submitFrmSectionAboutblock: function () {
            if ($('#frmSectionAboutblock').validate().form()) {
                var edit = $('#frmSectionAboutblock input[name=editing]').val() != '' ? $('#frmSectionAboutblock input[name=editing]').val() : 'N';
                $('#no-content').addClass('hide');
                $('#has-content').removeClass('hide');
                var folderid = $('#frmSectionAboutblock').find('.folder_1').val();
                var val = $('#frmSectionAboutblock').find('.imgip').val();
                var imgCaption = $('#frmSectionAboutblock #img_title').val();
                var imgsrc = $('#frmSectionAboutblock').find('.thumbnail img').attr('src');
                var content = sectionAboutblockCk.getData();
                var type = $('#frmSectionAboutblock input[name=selector]:checked').val();
        
                var buttontitle = $('#frmSectionAboutblock #buttontitle').val();
                var buttonlink = $('#frmSectionAboutblock #buttonlink').val();
                var tagline = $('#frmSectionAboutblock #tagline').val();
        
                builder.addAboutblock(imgsrc, val, imgCaption, content, type, edit,folderid, buttontitle, buttonlink, tagline);
                builder.reInitSortable();
                $('#sectionAboutblock').modal('hide');
            }
        },
...
$(document).on('click', '.add-element', function (event) {
    ...
    $(".only-spacer").show();
    $(".home-information").parent().css("display","none");
    $(".contact-info").parent().css("display","none");
    ...
    if (typeof innerplusdada != 'undefined') {
        ...
        $("#events_tab").hide();
        $("#blogs_tab").hide();
        $(".about-block").parent().css("display","none");
        $("#news_tab").hide();
        $(".photoalbum").hide();
    ...
    // $(".iframeonly").hide();
    $(".iframeonly").parent().css("display","none");
        $("#services_tab").hide();
        $("#work_tab").hide();
        $("#products_tab").hide();
        $("#careers_tab").hide();
...
$(document).on('click', '.only-image', function (event) {
    ...
    } else if (typeof id != 'undefined')
    {
        ...
        $('#sectionOnlyImage img:first').attr('src', site_url + '/assets/images/packages/visualcomposer/plus-no-image.png');
...
$(document).on('click', '.about-block', function (event) {
    $('#pgBuiderSections').modal('hide');
    $('#sectionAboutblock').modal({
        backdrop: 'static',
        keyboard: false
    });
    var id = $(this).data('id');
    ...
    if ($('.columns_1.clicked').parents('.col_1').find('.two_col_1 .imgcontentclass').length == 1) {
        ...
        var align = colData.data('type');
        var content = colData.val();
        var buttontitle = colData.data('buttontitle');
        var buttonlink = colData.data('buttonlink');
        var tagline = colData.data('tagline');
         var strfid = id.split("-");   
        if (colData.data('folderid') != '' && typeof colData.data('folderid') != 'undefined') {     
            var folderid = colData.data('folderid');     
        }else{     
        ...
        var src = $('.columns_1.clicked').parents('.col_1').find('.two_col_1 img').attr('src');
        $('#sectionAboutblock .imgip').val(img);
        $('#sectionAboutblock img:first').attr('src', src);
        $('#sectionAboutblock #img_title').val(caption);
        $('#sectionAboutblock #vfolder_id').val(folderid);
        $('#sectionAboutblock textarea').val(content);
        $('#sectionAboutblock input[value="' + align + '"]').prop('checked', true);

        $('#sectionAboutblock #buttontitle').val(buttontitle);
        $('#sectionAboutblock #buttonlink').val(buttonlink);
        $('#sectionAboutblock #tagline').val(tagline);

        $('#sectionAboutblock #addSection').text('Update');
        $('#sectionAboutblock #exampleModalLabel b').text('Edit About Block');
    ...
    {
         var strfid = id.split("-");   
        if ($('.about-img-rt-area #' + id).data('folderid') != '' && typeof $('.about-img-rt-area #' + id).data('folderid') != 'undefined') {     
            var folderid = $('.about-img-rt-area #' + id).data('folderid');     
        }else{     
            var folderid = $('.folder_' + strfid[1]).val();    
        }
        var img = $('.about-img-rt-area #' + id).data('id');
        var caption = $('.about-img-rt-area #' + id).data('caption');
        var align = $('.about-img-rt-area #' + id).data('type');
        var content = $('.about-img-rt-area #' + id).val();
        var src = $('.about-img-rt-area .' + id).attr('src');

        var buttontitle = $('.about-img-rt-area #' + id).data('buttontitle');
        var buttonlink = $('.about-img-rt-area #' + id).data('buttonlink');
        var tagline = $('.about-img-rt-area #' + id).data('tagline');

        $('#sectionAboutblock input[name=editing]').val(id);
        $('#sectionAboutblock .imgip').val(img);
        $('#sectionAboutblock img:first').attr('src', src);
        $('#sectionAboutblock #img_title').val(caption);
        $('#sectionAboutblock #vfolder_id').val(folderid);
        ...
        $('#sectionAboutblock input[name=editing]').val('');
        $('#sectionAboutblock .imgip').val('');
        $('#sectionAboutblock img:first').attr('src', site_url + '/assets/images/packages/visualcomposer/plus-no-image.png');
        $('#sectionAboutblock #img_title').val('');
        $('#sectionAboutblock textarea').val('');
        $('#sectionAboutblock input:checked').prop('checked', false);

        $('#sectionAboutblock #buttontitle').val('');
        $('#sectionAboutblock #buttonlink').val('');
        $('#sectionAboutblock #tagline').val('');

        $('#sectionAboutblock #addSection').text('Add');
        $('#sectionAboutblock #exampleModalLabel b').text('About Block');

        
    }

    $('#sectionAboutblock .ck-editor').remove();

    ClassicEditor.create(document.querySelector('#sectionAboutblock #ck-area'), cmsConfig)
            .then(editor => {
                window.sectionAboutblockCk = editor;
            })
            .catch(error => {
                console.error(error);
            });
...
$('#sectionAboutblock').on('shown.bs.modal', function () {
    builder.resizeImageContentModal();
    validateSectionAboutblock.init();
}).on('hidden.bs.modal', function () {
    validateSectionAboutblock.reset();
});
...
$(document).on('click', '.blogs-template', function (event) {
    ...
    if (typeof id != 'undefined')
    {
        var extclass = $('#' + id).data('class');
        // var value = $('#' + id).val();
        var value = $('.blogsTemplate').find('.txtip').val();
        layout = $('#' + id).data('layout');
        slimit = $('#' + id).data('slimit');
        sdesc = $('#' + id).data('sdesc');
        config = $('#' + id).data('config');
            ...
            rules: {
                ...
                video_id: {
                    ...
                    urlvalidate: {
                        depends: function ()
                        {
                            var Type = $("#frmSectionVideo").find("input[name='chrVideoType']:checked").val();
...
var validateSectionAboutblock = function () {
    var handleSectionAboutblock = function () {
        $("#frmSectionAboutblock").validate({
            errorElement: 'span', //default input error message container
            errorClass: 'help-block', // default input error message class
            ignore: [],
            rules: {
            ...
            invalidHandler: function (event, validator) { //display error alert on form submit
                ...
                $('.alert-danger', $('#frmSectionAboutblock')).show();
            },
            highlight: function (element) { // hightlight error inputs
                $(element).closest('.form-group').addClass('has-error'); // set error class to the control group
            },
            ...
            submitHandler: function (form) {
                builder.submitFrmSectionAboutblock();
                return false;
            }
        });

        $('#frmSectionAboutblock #addSection').click(function () {
            sectionAboutblockCk.updateSourceElement();
        });

        $('#frmSectionAboutblock input').keypress(function (e) {
            if (e.which == 13) {
                builder.submitFrmSectionAboutblock();
                return false;
            }
    ...
    return {
        //main function to initiate the module
        init: function () {
            handleSectionAboutblock();
        },
        reset: function () {
            var validator = $("#frmSectionAboutblock").validate();
            validator.resetForm();
        }
    };
}();
            ...
            rules: {
                ...
                video_id: {
                    ...
                    urlvalidate1: {
                        depends: function ()
                        {
                            var Type = $("#frmsectionVideoContent").find("input[name='chrVideoType']:checked").val();
                            if (Type == 'YouTube' || Type == 'Vimeo')
                            {
                                return true;
                            }
...
function checkvimeo(link)
{
    var url = link;
    var isvimeoUrl = /^(http\:\/\/|https\:\/\/)?(www\.)?(vimeo\.com\/)([0-9]+)$/.test(url);
    return isvimeoUrl;
}
jQuery(document).ready(function () {

    var chrType = $("#frmSectionVideo").find("input[name='chrVideoType']:checked").val();
    if(chrType == "YouTube")
    {
        jQuery.validator.addMethod("urlvalidate", function (value, element)
        {
            if ($("#frmSectionVideo").find("input[name='chrVideoType']").is(':checked'))
            {
                var link = $("#frmSectionVideo").find("input[name='video_id']").val();
                return checkYoutube(value);
            } else
            {
                return true;
            }
    ...
    $("#frmSectionVideo").find("input[name='chrVideoType']").on('click', function () {
        var chrType = $("#frmSectionVideo").find("input[name='chrVideoType']:checked").val();
        if(chrType == "YouTube")
        {
            jQuery.validator.addMethod("urlvalidate", function (value, element)
        ...
        else
        {
            jQuery.validator.addMethod("urlvalidate", function (value, element)
            {
                if ($("#frmSectionVideo").find("input[name='chrVideoType']").is(':checked') && $("input[name='chrVideoType']:checked").val() == "Vimeo")
                {
                    var link = $("#frmSectionVideo").find("input[name='video_id']").val();
                    return checkvimeo(value);
                } else
                {
                    return true;
                }
            }, 'Please enter valid vimeo url.');
        }
    });

    var chrType1 = $("#frmsectionVideoContent").find("input[name='chrVideoType']:checked").val();
    if(chrType1 == "YouTube")
    {
        jQuery.validator.addMethod("urlvalidate1", function (value, element)
        {
            if ($("#frmsectionVideoContent").find("input[name='chrVideoType']").is(':checked'))
            {
                var link = $("#frmsectionVideoContent").find("input[name='video_id']").val();
                return checkYoutube(value);
            } else
            {
                return true;
    ...
    $("#frmsectionVideoContent").find("input[name='chrVideoType']").on('click', function () {
        var chrType1 = $("#frmsectionVideoContent").find("input[name='chrVideoType']:checked").val();
        if(chrType1 == "YouTube")
        {
            jQuery.validator.addMethod("urlvalidate1", function (value, element)
        ...
        $("#frmSectionPhotoAlbumModule").validate({
            ...
            rules: {
                ...
                'delete[]': {
                    required: {
                        depends: function () {
                            return $('#frmSectionPhotoAlbumModule input[name="editing"]').val().length == '';
                        }
                    }
                }
            },
            ...
            errorPlacement: function (error, element) {
                if (element.parent('.input-group').length) {
                    ...
                    error.insertBefore($('#frmSectionPhotoAlbumModule .table-container .table:first'));
                } else if (element.hasClass('select2')) {
                    error.insertAfter(element.next('span'));
                } else if (element.attr('id') == 'ck-area') {
                    error.insertAfter(element.next('.ck-editor'));
        ...
        $("#frmSectionVideoAlbumModule").validate({
            ...
            rules: {
                ...
                'delete[]': {
                    required: {
                        depends: function () {
                            return $('#frmSectionVideoAlbumModule input[name="editing"]').val().length == '';
                        }
                    }
                }
            },
            ...
            errorPlacement: function (error, element) {
                if (element.parent('.input-group').length) {
                    ...
                    error.insertBefore($('#frmSectionVideoAlbumModule .table-container .table:first'));
                }  else if (element.hasClass('select2')) {
                    error.insertAfter(element.next('span'));
                } else if (element.attr('id') == 'ck-area') {
                    error.insertAfter(element.next('.ck-editor'));
