var Setting = function () {
    var handleSetting = function () {
        $('#frmSettings').validate({
            ...
            rules: {
                ...
                default_serviceinquiry_email: {
                    required: true,
                    email: true,
                },
                default_boatinquiry_email: {
                    required: true,
                    email: true,
                },
                // default_getaestimate_email: {
                //     required: true,
                //     email: true,
                // },
            ...
            messages: {
                ...
                front_logo_id: Lang.get('validation.required', {
                    required: "Front header logo field is required.",
                }),
                front_footer_logo_id: {
                    required: "Front footer logo field is required.",
                },
                default_custom_email: {
                    required: "Default email field is required.",
                },
                default_contactus_email: {
                    required: "Default contact email field is required.",
                },
                default_serviceinquiry_email: {
                    required: "Default service inquiry email field is required.",
                },
                default_boatinquiry_email: {
                    required: "Default boat inquiry email field is required.",
                },
                default_getaestimate_email: {
                    required: "Default get free estimate form email field is  required.",
                },
                default_newsletter_email: {
                    required: "Default newsletter email field is  required.",
                },
                default_dataremoval_email: {
                    required: "Default data removal email field is  required.",
                },
            },
    ...
    var handleSocialSetting = function() {
    		$('#frmSocial').validate({
    				...
    				messages: {
    						fb_link: {
                                    required: "Facebook link field is required.",
    								url: Lang.get('validation.url', {
    										attribute: Lang.get('template.settingModule.validUrl')
    								}),
    						},
    						twitter_link: {
                                    required: "Twitter link field is required.",
    								url: Lang.get('validation.url', {
    										attribute: Lang.get('template.settingModule.validUrl')
    								}),
    						},
    						instagram_link: {
                                    required: "Instagram link field is required.",
    								url: Lang.get('validation.url', {
    										attribute: Lang.get('template.settingModule.validUrl')
    								}),
    						},
    						pinterest_link: {
                                    required: "Pinterest link field is required.",
    								url: Lang.get('validation.url', {
    										attribute: Lang.get('template.settingModule.validUrl')
    								}),
    						},
    						yelp_link: {
                                    required: "Yelp link field is required.",
    								url: Lang.get('validation.url', {
    										attribute: Lang.get('template.settingModule.validUrl')
    								}),
    						}
    ...
    var handleOtherSetting = function () {
        $('#otherSettings').validate({
            ...
            messages: {
                ...
                google_capcha_secret : {
                    required: "Google captcha secret key field is required.",
                },
            },
            errorPlacement: function (error, element) {
                if (element.parent('.input-group').length) {
        ...
        $('#cronSettings').validate({
            ...
            messages: {
                log_remove_time: Lang.get('validation.required', {
                    attribute: Lang.get('Log remove time (month)')
                }),
            },
            errorPlacement: function (error, element) {
                if (element.parent('.input-group').length) {
