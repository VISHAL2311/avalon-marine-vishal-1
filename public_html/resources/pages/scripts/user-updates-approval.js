...
function rollbackRecord(id){
    $.ajax({
        ...
        success: function (data) {
            ...
            // $('#RollbackSuccess .rollbackSuccessMsg').text("The record has been rollbacked successfully to previous version.");
            // $('#RollbackSuccess').show();
            // $('#RollbackSuccess').modal({
            //     backdrop: 'static',
            //     keyboard: false
            // });
            
            //$(document).on('click', '#RollbackOk', function () {
