...
$(document).on('click', '#refresh', function (e) {
    $("#rolefilter, #categoriesfilter, #modulefilter, #foritem, #statusfilter, #pageFilter, #bannerFilter, #bannerFilterType,#category_id,#searchfilter,.category_filter,.list_head_filter,#emailtypefilter").val('').trigger('change');
    $('#searchfilter').keyup();
});
...
function addClassCkeditorscrollbar(){
    $('.ck-dropdown__panel_se ul').addClass('scrolldown');
}