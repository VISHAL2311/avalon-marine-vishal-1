                                            ...
                                            <div class="twocol1">
                                                ...
                                                <div class="col-md-3 text-right">                    
                                                    <div class="image-align-box">
                                                        ...
                                                        <div class="image-align-box">
                                                            <i class="icon"><img title="Align Left" height="45" width="50" src="{{ url('assets/images/image-left.png') }}" alt=""></i>
                                                        </div>
                                                        @elseif($section->val->alignment == 'image-rt-txt')
                                                        <i class="icon"><img title="Align Right" height="45" width="50" src="{{ url('assets/images/image-right.png') }}" alt=""></i>
                                                        @elseif($section->val->alignment == 'image-center-txt')
                                                        <i class="icon"><img title="Align Top" height="45" width="50" src="{{ url('assets/images/image-center.png') }}" alt=""></i>
                                                        @endif
                                                    </div>
                                                </div>
                                                @endif
                                                ...
                                                <div class="col-md-3 text-right">                    
                                                    <div class="image-align-box">
                                                        ...
                                                        <div class="image-align-box">
                                                            <i class="icon"><img title="Align Left" height="45" width="50" src="{{ url('assets/images/left-image.png') }}" alt=""></i>
                                                        </div>
                                                        @elseif($section->val->alignment == 'rt-txt')
                                                        <i class="icon"><img title="Align Right" height="45" width="50" src="{{ url('assets/images/right-image.png') }}" alt=""></i>
                                                        @elseif($section->val->alignment == 'top-txt')
                                                        <i class="icon"><img title="Align Top" height="45" width="50" src="{{ url('assets/images/top-image.png') }}" alt=""></i>
                                                        @elseif($section->val->alignment == 'bot-txt')
                                                        <i class="icon"><img title="Align Bottom" height="45" width="50" src="{{ url('assets/images/bottom-image.png') }}" alt=""></i>
                                                        @elseif($section->val->alignment == 'center-txt')
                                                        <i class="icon"><img title="Align Center" height="45" width="50" src="{{ url('assets/images/center-image.png') }}" alt=""></i>
                                                        @endif
                                                    </div>
                                                </div>
                                                @endif
                                                ...
                                                <div class="col-md-3 text-right">                    
                                                    <div class="image-align-box">
                                                        ...
                                                        @if($section->val->alignment == 'lft-txt')
                                                        <div class="image-align-box">
                                                            <i class="icon"><img title="Align Left" height="45" width="50" src="{{ url('assets/images/left-video.png') }}" alt=""></i>
                                                        </div>
                                                        @elseif($section->val->alignment == 'rt-txt')
                                                        <i class="icon"><img title="Align Right" height="45" width="50" src="{{ url('assets/images/right-video.png') }}" alt=""></i>
                                                        @elseif($section->val->alignment == 'top-txt')
                                                        <i class="icon"><img title="Align Top" height="45" width="50" src="{{ url('assets/images/top-video.png') }}" alt=""></i>
                                                        @elseif($section->val->alignment == 'bot-txt')
                                                        <i class="icon"><img title="Align Bottom" height="45" width="50" src="{{ url('assets/images/bottom-video.png') }}" alt=""></i>
                                                        @elseif($section->val->alignment == 'center-txt')
                                                        <i class="icon"><img title="Align Center" height="45" width="50" src="{{ url('assets/images/center-video.png') }}" alt=""></i>
                                                        @endif
                                                    </div>
                                                </div>
                                                @endif
                                                ...
                                                <div class="col-md-3 text-right">                    
                                                    <div class="image-align-box">
                                                        ...
                                                        <div class="image-align-box">
                                                            <i class="icon"><img title="Align Left" height="45" width="50" src="{{ url('assets/images/home-left-image.png') }}" alt=""></i>
                                                        </div>
                                                        @elseif($section->val->alignment == 'home-rt-txt')
                                                        <i class="icon"><img title="Align Right" height="45" width="50" src="{{ url('assets/images/home-right-image.png') }}" alt=""></i>
                                                        @elseif($section->val->alignment == 'home-top-txt')
                                                        <i class="icon"><img title="Align Top" height="45" width="50" src="{{ url('assets/images/home-top-image.png') }}" alt=""></i>
                                                ...
                                                <div class="col-md-2 text-right">                    
                                                    <div class="image-align-box">
                                                        ...
                                                        <div class="image-align-box">
                                                            <i class="icon"><img title="Align Left" height="45" width="50" src="{{ url('assets/images/left-button.png') }}" alt=""></i>
                                                        </div>
                                                        @elseif($section->val->alignment == 'button-rt-txt')
                                                        <i class="icon"><img title="Align Right" height="45" width="50" src="{{ url('assets/images/right-button.png') }}" alt=""></i>
                                                        @elseif($section->val->alignment == 'button-center-txt')
                                                        <i class="icon"><img title="Align Top" height="45" width="50" src="{{ url('assets/images/center-button.png') }}" alt=""></i>
                                                        @endif
                                                    </div>
                                                </div>
