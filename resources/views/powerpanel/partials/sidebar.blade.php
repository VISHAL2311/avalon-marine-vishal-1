    ...
    <div class="page-sidebar navbar-collapse collapse">
        <div class="scroller" style="max-height:calc(100vh - 100px);" data-rail-visible="1" data-rail-color="#fff" data-handle-color="#ccc">
            <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                ...
                <li class="nav-item @if( isset($menuArr['sitemg']) && $menuArr['sitemg']=='active' ) active @endif @if( isset($menuArr['sitemgopen']) && $menuArr['sitemgopen']=='open' ) open @endif">
                    ...
                    <ul class="sub-menu" style="display: block;">
                        ...
                        <li class="nav-item start {{ $menuArr['contact_info_active'] }} {{ $menuArr['contact_info_open'] }}">
                            <a title="{{ trans('template.sidebar.contact') }}" href="{{ url('/powerpanel/contact-info/1/edit') }}" class="nav-link nav-toggle">
                        ...
                        @endif
                        @if(isset($menuArr['can-brand-list']) && $menuArr['can-brand-list'])
                        <li class="nav-item {{ $menuArr['brand_active'] }} {{ $menuArr['brand_open'] }}">
                            <a title="{{ trans('template.sidebar.brand') }}" href="{{ url('powerpanel/brand') }}" class="nav-link nav-toggle">
                                <i class="fa fa-fa"></i>
                                <span class="title">{{ trans('template.sidebar.brand') }}</span>
                                <span class="{{ $menuArr['brand_selected'] }}"></span>
                            </a>
                        </li>
                        @endif
                        @if(isset($menuArr['can-boats-category-list']) && $menuArr['can-boats-category-list'])
                        <li class="nav-item {{ $menuArr['boat_category_active'] }} {{ $menuArr['boat_category_open'] }}">
                            <a title="{{ trans('template.sidebar.boatcategory') }}" href="{{ url('powerpanel/boat-category') }}" class="nav-link nav-toggle">
                                <i class="fa fa-ship"></i>
                                <span class="title">{{ trans('template.sidebar.boatcategory') }}</span>
                                <span class="{{ $menuArr['boat_category_selected'] }}"></span>
                            </a>
                        </li>
                        @endif
                        @if(isset($menuArr['can-boats-list']) && $menuArr['can-boats-list'])
                        <li class="nav-item {{ $menuArr['boat_active'] }} {{ $menuArr['boat_open'] }}">
                            <a title="{{ trans('template.sidebar.boat') }}" href="{{ url('powerpanel/boat') }}" class="nav-link nav-toggle">
                                <i class="fa fa-ship"></i>
                                <span class="title">{{ trans('template.sidebar.boat') }}</span>
                                <span class="{{ $menuArr['boat_selected'] }}"></span>
                            </a>
                        </li>
                        @endif
                ...
                (isset($menuArr['can-brand-list']) && $menuArr['can-brand-list']) ||
                ...
                (isset($menuArr['can-boats-category-list']) && $menuArr['can-boats-category-list']) ||
                (isset($menuArr['can-boats-list']) && $menuArr['can-boats-list']) ||
            ...
            (isset($menuArr['can-service-inquiry-list']) && $menuArr['can-service-inquiry-list']) ||
            ...
            (isset($menuArr['can-data-removal-lead-list']) && $menuArr['can-data-removal-lead-list']) ||
            ...
            <li class="nav-item {{ (isset($menuArr['leadmg']) && $menuArr['leadmg']=='active')? 'open active' : '' }}">
                ...
                <ul class="sub-menu">
                    ...
                    @endif
                    @if(isset($menuArr['can-service-inquiry-list']) && $menuArr['can-service-inquiry-list'])
                    <li class="nav-item {{ $menuArr['serviceinquiry_active'] }}">
                        <a title="{{ trans('template.sidebar.serviceinquirylead') }}" href="{{ url('powerpanel/service-inquiry') }}" class="nav-link ">
                            <i class="fa fa-cogs"></i>
                            <span class="title">{{ trans('template.sidebar.serviceinquirylead') }}</span>
                            <span class="{{ $menuArr['serviceinquiry_selected'] }}"></span>
                        </a>
                    </li>
                    @endif
                    @if(isset($menuArr['can-boat-inquiry-list']) && $menuArr['can-boat-inquiry-list'])
                    <li class="nav-item {{ $menuArr['boatinquiry_active'] }}">
                        <a title="{{ trans('template.sidebar.boatinquirylead') }}" href="{{ url('powerpanel/boat-inquiry') }}" class="nav-link ">
                            <i class="fa fa-ship"></i>
                            <span class="title">{{ trans('template.sidebar.boatinquirylead') }}</span>
                            <span class="{{ $menuArr['boatinquiry_selected'] }}"></span>
                        </a>
                    </li>
                    @endif
                    @if(isset($menuArr['can-get-a-estimate-list']) && $menuArr['can-get-a-estimate-list'])
                        <li class="nav-item {{ $menuArr['getaestimate_active'] }}">
                            <a title="Get Free Estimate Leads" href="{{ url('powerpanel/get-a-estimate') }}" class="nav-link ">
                                <i class="fa fa-phone"></i>
                                <span class="title">Get Free Estimate Leads </span>
                    ...
                    @endif
                    @if(isset($menuArr['can-data-removal-lead-list']) && $menuArr['can-data-removal-lead-list'])
                    <li class="nav-item {{ $menuArr['dataremoval_active'] }}">
                        <a title="{{ trans('template.sidebar.dataremovalleads') }}" href="{{ url('powerpanel/data-removal-lead') }}" class="nav-link ">
                            <i class="fa fa-newspaper-o"></i>
                            <span class="title">{{ trans('template.sidebar.dataremovalleads') }}</span>
                            <span class="{{ $menuArr['dataremoval_selected'] }}"></span>
                        </a>
                    </li>
                    @endif
