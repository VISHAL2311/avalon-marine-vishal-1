...
<div class="page-header navbar navbar-fixed-top">
	...
	tt=display_c();
                   ...
                   <li class="dropdown date_clock"><div class="date_timer_powerpanel"><span id="ct"><?php  echo  date("F j, Y");?></span><span id="ct_2"><?php  echo date("g:i a");?></span></div></li>
                    ...
                    <li class="dropdown dropdown-user viewsitemobile dro pdown-browser">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            if($versiondata[0] <= 95 && $browser=='Edge'){
                            ...
                            <li>
                                <a href="javascript:void(0)">
                                    ...
                                    <span class="brows-version">95 +</span>
                                    @if($versiondata[0] <= 95 && $browser=='Edge')
                    ...
                    <li class="dropdown dropdown-user viewsitemobile {{ $menuArr['liveuser_active'] }}" style="display:none;">
                    ...
                    <li class="dropdown dropdown-search open" style="display:none;">
                    ...
                    <li class="dropdown dropdown-notification" style="display:none;">
