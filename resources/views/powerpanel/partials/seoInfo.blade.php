...
<div class="row" id="edit_seo">
    <div class="col-md-12">	 
        <div class="form-group"> 
            ...
            <button type="button" id='auto-generate' class="btn btn-green-drake" onclick="generate_seocontent('@if(!empty($form)){{ $form }}@endif');">{{ trans('template.common.autogenerate') }}</button>
