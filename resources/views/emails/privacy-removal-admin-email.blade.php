...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td align="left" valign="top"><table width="600" border="0" align="left" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td align="left" valign="top" style="font-family:'Segoe UI','Segoe WP','Segoe UI Regular','Helvetica Neue',Helvetica,Tahoma,'Arial Unicode MS',Sans-serif; font-size:13px; line-height:19.5px; font-weight:400; color:#222222; padding:5px 0 0 0;">{{ $varFirstName }} has requested to remove his/her stored data permanently from the database within two weeks. Below are the received request details.</td>
            </tr>
            <tr>
                <td align="left" valign="top" style="font-family:'Segoe UI','Segoe WP','Segoe UI Regular','Helvetica Neue',Helvetica,Tahoma,'Arial Unicode MS',Sans-serif; font-size:13px; line-height:19.5px; font-weight:400; color:#222222; padding:5px 0 0 0;">You can find the data from PowerPanel by his/her name and delete them permanently from the database. 
                  <a href="{{ url('/powerpanel/data-removal-lead') }}" target="_blank" style="font-family:'Segoe UI','Segoe WP','Segoe UI Regular','Helvetica Neue',Helvetica,Tahoma,'Arial Unicode MS',Sans-serif; font-size:13px; line-height:19.5px; font-weight:600; color:#0080d9; text-decoration:none;">Click here</a> to find stored records in the PowerPanel.
                </td>
            </tr>
            <tr>
                ...
                <td align="left" valign="top" style="padding:15px 0;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                        <tr>
                            ...
                            <td width="80%" align="left" valign="top" style="font-family:'Segoe UI','Segoe WP','Segoe UI Regular','Helvetica Neue',Helvetica,Tahoma,'Arial Unicode MS',Sans-serif; font-size:13px; line-height:19.5px; font-weight:400; color:#222222; padding:0 0 5px 0; text-transform:capitalize;">{{ $varFirstName }}</td>
                        </tr>
                        <tr>
                            ...
                            <td align="left" valign="top" style="padding:0 0 5px 0;"><a href="mailto:{{ $varEmail }}" target="_blank" style="font-family:'Segoe UI','Segoe WP','Segoe UI Regular','Helvetica Neue',Helvetica,Tahoma,'Arial Unicode MS',Sans-serif; font-size:13px; line-height:19.5px; font-weight:400; color:#222222; text-decoration:none;">{{ $varEmail }}</a></td>
                        </tr>
                        @if(isset($varReason) && !empty($varReason))
                        <tr>
                            ...
                            <td align="left" valign="top" style="font-family:'Segoe UI','Segoe WP','Segoe UI Regular','Helvetica Neue',Helvetica,Tahoma,'Arial Unicode MS',Sans-serif; font-size:13px; line-height:19.5px; font-weight:400; color:#222222; padding:0 0 5px 0;">{!! nl2br($varReason) !!}</td>
                        </tr> 
                        @endif
                    </tbody>
                </table>
            ...
            <tr>
                <td align="left" valign="top" style="font-family:'Segoe UI','Segoe WP','Segoe UI Regular','Helvetica Neue',Helvetica,Tahoma,'Arial Unicode MS',Sans-serif; font-size:13px; line-height:19.5px; font-weight:400; color:#222222; padding:0 0 0 0;"><strong>Powered by </strong> <a href="https://netclues.ky/" rel="nofollow" target="_blank" style="font-family:'Segoe UI','Segoe WP','Segoe UI Regular','Helvetica Neue',Helvetica,Tahoma,'Arial Unicode MS',Sans-serif; font-size:13px; line-height:19.5px; font-weight:400; text-decoration:none;">Netclues!</a></td>
            </tr>
            <tr style="width:100%">
                <td style="font-family:Arial, Helvetica, sans-serif; font-size:13px; ; line-height:16px;"><img alt="Netclues Logo" src="{{url('assets/images/netclues_logo.png')}}" title="Netclues Logo" style="display: inline-block;padding-top:15px;" width="150" height="auto" border="0"></td>
            </tr>
        </table></td>
    </tr>
</table>
