            ...
            <tr>
                <td valign="top">
                        ...
                        <tr>
                            <td align="center" valign="top" bgcolor="#fff" style="padding:20px 0;">
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td style="font-family:Arial, Helvetica, sans-serif; font-size:15px;line-height:24px;">A new boat enquiry has been received. Please find the enquiry details as follows.</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <td height="20" align="left" valign="middle" style="font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:30px;"><strong>Enquirer Details:</strong></td>
                                                </tr>
                                                <tr>
                                                ...
                                                @endif
                                                @if(isset($boats_name) && !empty($boats_name))
                                                <tr>
                                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:24px;"><strong>Interested In:</strong> {{ $boats_name }}</td>
                                                </tr>
                                                @endif
                                                @if(isset($user_message) && !empty($user_message))
                                                <tr>
                                                    <td style="font-family:Arial, Helvetica, sans-serif; font-size:15px; line-height:24px;"><strong>Comment:</strong> {!! $user_message !!}</td>
                                                </tr>
                                                @endif
                                                <tr>
                                                    <td>&nbsp;</td>
                    ...
                    <table cellpadding="0" cellspacing="0" class="responsive_width" style="padding:20px;">
                        ...
                        <br>
                        <tr style="width:100%">
                            <td style="font-family:Arial, Helvetica, sans-serif; font-size:13px; ; line-height:16px;"><strong>Powered by </strong> <a href="https://netclues.ky/" rel="nofollow" target="_blank" style="font-family:Arial, Helvetica, sans-serif; font-size:13px; ; line-height:16px;">Netclues!</a></td>
                        </tr>
                        <tr style="width:100%">
